...
const CACHE_VERSION = CACHE_PREFIX + 'v299';
...
const PRECACHE_URLS = [
  ...
  /* 剝半／磨粉／管灌的外部補充層（美國 FDA 仿單）。台大那一欄只有 53% 的口服品項
     有值，這支補其餘的；與 index.js 同為開頁即載，離線漏掉會整層不見。 */
  './data/drugs/crush-ext.js',
