...
"s": ["腹部", "創傷", "肝臟", "胰臟", "腎臟", "脾臟", "胃十二指腸", "大腸", "泌尿系統", "腹膜"], "c": ["腹部創傷", "創傷", "出血"], "a": ["要不要開刀", "定嚴重度", "判時機", "選術式", "找原因", "要不要照CT"], "impl": ""},
    ...
    {"k": "abx-mode-empiric", "name": "依部位", "en": "Empiric by Site", "desc": "抗生素指引、菌譜資料庫、手術預防與創傷用藥", "kind": "mode", "href": "tools/antibiotics.html#mode=empiric", "sec": "hubs", "secTitle": "入口", "secEn": "Hubs", "grp": "抗微生物", "grpEn": "Antimicrobials", "cnt": "6 項", "s": ["感染與敗血", "腹膜", "腹部", "膽道", "軟組織", "肺與氣道", "腎臟", "心臟", "腦", "泌尿系統"], "c": ["抗生素選擇", "感染"], "a": ["查覆蓋菌譜", "給抗生素"], "kw": "抗生素 抗微生物 經驗性用藥 菌譜 感受性 腹膜炎 腹膜透析 腹透 peritonitis peritoneal dialysis PD CAPD APD 腹腔內注射 intraperitoneal IP", "impl": ""},
