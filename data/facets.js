...
"s": ["腹部", "創傷", "肝臟", "胰臟", "腎臟", "脾臟", "胃十二指腸", "大腸", "泌尿系統", "腹膜"], "c": ["腹部創傷", "創傷", "出血"], "a": ["要不要開刀", "定嚴重度", "判時機", "選術式", "找原因", "要不要照CT"], "impl": ""},
    ...
    {"k": "pe", "name": "肺栓塞", "en": "Acute Pulmonary Embolism", "desc": "依 2019 ESC 之診斷路徑（臨床機率、D-dimer、CTPA）、危險分層（休克、sPESI、右心室功能與心肌指標），到抗凝與再灌流治療與各藥物劑量", "kind": "guide", "href": "tools/pe.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "休克與復甦", "grpEn": "Shock & Resuscitation", "cnt": "7 項", "s": ["肺循環"], "c": ["肺栓塞"], "a": ["定嚴重度", "查劑量", "判時機"], "impl": ""},
    ...
    {"k": "acs", "name": "急性冠心症", "en": "Acute Coronary Syndrome", "desc": "分流、心電圖判讀、再灌流時機（直接 PCI 與溶栓）、抗栓藥物與依體重換算之劑量；另含支架置放後之 DAPT 時長與緊急 CABG 的處理", "kind": "guide", "href": "tools/acs.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "心臟", "grpEn": "Cardiac", "cnt": "4 項", "s": ["冠狀動脈", "心臟"], "c": ["急性冠心症"], "a": ["查劑量", "判時機", "定嚴重度", "選術式"], "impl": ""},
    ...
    {"k": "stroke", "name": "缺血性中風", "en": "Acute Ischemic Stroke", "desc": "依 2026 AHA/ASA 分流、靜脈溶栓（alteplase／tenecteplase 各有劑量上限）、動脈取栓適應症與時間窗，以及血壓、抗栓與併發症之早期處置", "kind": "guide", "href": "tools/stroke.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "神經", "grpEn": "Neurology", "cnt": "4 項", "s": ["腦血管"], "c": ["缺血性中風"], "a": ["判時機", "查劑量", "定嚴重度"], "impl": ""},
    ...
    {"k": "abx-mode-empiric", "name": "依部位", "en": "Empiric by Site", "desc": "抗生素指引、菌譜資料庫、手術預防、創傷用藥、注射轉口服、輸注與藥物相容性", "kind": "mode", "href": "tools/antibiotics.html#mode=empiric", "sec": "hubs", "secTitle": "入口", "secEn": "Hubs", "grp": "抗微生物", "grpEn": "Antimicrobials", "cnt": "8 項", "s": ["感染與敗血", "腹膜", "腹部", "膽道", "軟組織", "肺與氣道", "腎臟", "心臟", "腦", "泌尿系統"], "c": ["抗生素選擇", "感染"], "a": ["查覆蓋菌譜", "給抗生素"], "kw": "抗生素 抗微生物 經驗性用藥 菌譜 感受性 腹膜炎 腹膜透析 腹透 peritonitis peritoneal dialysis PD CAPD APD 腹腔內注射 intraperitoneal IP", "impl": ""},
    {"k": "abx-mode-bacteria", "name": "依病原菌", "en": "By Pathogen", "desc": "抗生素指引、菌譜資料庫、手術預防、創傷用藥、注射轉口服、輸注與藥物相容性", "kind": "mode", "href": "tools/antibiotics.html#mode=bacteria", "sec": "hubs", "secTitle": "入口", "secEn": "Hubs", "grp": "抗微生物", "grpEn": "Antimicrobials", "cnt": "8 項", "s": ["病原菌"], "c": ["抗生素選擇"], "a": ["查覆蓋菌譜", "找原因", "給抗生素"], "kw": "抗生素 抗微生物 經驗性用藥 菌譜 感受性", "impl": ""},
    ...
    {"k": "abx-trauma-abx", "name": "創傷用藥", "en": "Trauma Antibiotics", "desc": "依損傷部位整理創傷後預防性抗生素的建議、療程與證據強度，並含破傷風預防決策", "kind": "guide", "href": "tools/trauma-abx.html", "sec": "hubs", "secTitle": "入口", "secEn": "Hubs", "grp": "抗微生物", "grpEn": "Antimicrobials", "cnt": "8 項", "s": ["抗生素"], "c": ["抗生素選擇", "創傷後抗生素", "創傷"], "a": ["查覆蓋菌譜", "給抗生素"], "kw": "抗生素 抗微生物 菌譜 手術預防 創傷", "impl": ""},
