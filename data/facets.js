...
window.FACETS = {
  ...
  "c": [
    ...
    // 慢性糖尿病本身（原詞表只有 DKA／HHS／高血糖三個急性情境，查「糖尿病」會落空）。用藥指引頁 pathways/diabetes.html 掛在這個詞下。
    // 慢性高血壓本身（原詞表只有主動脈剝離、心因性休克等急性心血管情境，查「高血壓」會落空）。
    // 用藥指引頁 pathways/hypertension.html 掛在這個詞下。
    {"w": "高血壓", "al": "hypertension HTN high-blood-pressure 血壓 血壓高 高血壓 降血壓 降壓 降壓藥 BP 收縮壓 舒張壓 SBP DBP 居家血壓 722 白袍高血壓 隱匿型高血壓 難治型高血壓 resistant 高血壓急症 hypertensive-emergency hypertensive-urgency 續發性高血壓 原發性醛固酮症 primary-aldosteronism"},
    {"w": "糖尿病", "al": "diabetes DM T2DM T2D 第二型糖尿病 第2型糖尿病 二型糖尿病 糖尿 降血糖 血糖控制 HbA1c 糖化血色素"},
  ...
  /* ════════ kind 欄位：清單左邊那顆型別徽章印什麼（造句導覽的候選清單） ════════
     2026-08-18 依使用者裁決由兩類擴成三類。原本只有「計分／流程」，結果 ACLS、
     肺栓塞這種整理型頁面掛著「計分」，心因性休克、Swan-Ganz 這種多分頁頁面掛著
     「流程」，兩邊都名不副實。判準如下，**新增標的時照這個判，不要照檔案放在
     tools/ 還是 pathways/ 資料夾判**（目錄位置與型別無關，dm-path 與 hbv-path
     就是放在 pathways/ 的指引）：

       tool    「計分」 輸入數值或勾選 → 算出一個分數／分級的頁面。
                        判準就是 sec == "scores"（首頁「計分工具」那一分類），
                        雙向成立：在那一類的一定標 tool，標 tool 的一定在那一類。
       pathway 「流程」 一頁一條互動決策路徑，逐步選到底才給結論，中途不分頁。
                        闌尾炎、膽囊炎、敗血性休克、腸阻塞就是這一型。
       guide   「指引」 整理型／參考型頁面，**只要頁面有分頁列就一定是這一類**
                        （ACLS、心因性休克、Swan-Ganz、血管活性藥物對照、
                        糖尿病用藥、B 型肝炎用藥、電解質失衡、輸液營養…）。
                        沒有分頁但也不是逐步決策的參考頁（手術預防、注射轉口服）
                        同樣是指引。
       cancer  「癌別」 cancer.html 的單一癌別；癌症治療流程本身走這一類。
       mega    「總站」 底下自帶查詢或大量條目的入口頁（藥物資料庫、心電圖圖鑑）。
       mode    「模式」 同一頁的不同進入模式（抗生素的依部位／依病原菌／藥物查詢）。

     判錯會被 schema/check_kinds.py 擋下來（收尾一定要跑）：有分頁的頁面標成
     pathway、或計分工具分類的頁面沒標成 tool，都會報錯。
     標籤字面與顏色在 js/sentence-nav.js 的 KIND_META 與 css/ui-sentence.css 的
     .sh-kind-l.k-*，改字面請改那兩處，不要在這裡放第二份真相。 ════════ */
  "tools": [
    {"k": "appy-path", "name": "急性闌尾炎", "en": "Appendicitis", "desc": "依複雜度、族群與膿瘍年齡分流，決定手術或非手術治療（WSES 2025 Jerusalem Guidelines · JAMA Surg 2026）", "kind": "pathway", "href": "pathways/appendicitis.html", "sec": "abdomen", "secTitle": "腹部急症", "secEn": "Abdominal Emergencies", "grp": "感染", "grpEn": "Infection", "s": ["闌尾", "腹部", "腹膜"], "c": ["闌尾炎", "腹腔感染", "腹內膿瘍", "免疫低下", "感染"], "a": ["要不要開刀", "判時機", "選術式", "定嚴重度", "找原因"]},
    {"k": "chole-path", "name": "急性膽囊炎", "en": "Acute Cholecystitis", "desc": "先分流合併之膽道／胰臟問題，再依 TG18 嚴重度與手術風險決定早期腹腔鏡手術、膽囊引流或保守治療（TG18 · WSES · AAST）", "kind": "pathway", "href": "pathways/cholecystitis.html", "sec": "abdomen", "secTitle": "腹部急症", "secEn": "Abdominal Emergencies", "grp": "感染", "grpEn": "Infection", "s": ["膽道", "腹部", "腹膜"], "c": ["膽囊炎", "膽管炎", "腹腔感染", "膽道阻塞", "感染", "阻塞"], "a": ["要不要開刀", "判時機", "選術式", "定嚴重度", "找原因", "要不要引流"]},
    {"k": "divert-path", "name": "急性大腸憩室炎", "en": "Acute Colonic Diverticulitis", "desc": "依 WSES CT 分期與生理狀態決定門診治療、抗生素、經皮引流或術式，並判定非手術後之大腸評估（WSES 2020）", "kind": "pathway", "href": "pathways/diverticulitis.html", "sec": "abdomen", "secTitle": "腹部急症", "secEn": "Abdominal Emergencies", "grp": "感染", "grpEn": "Infection", "s": ["大腸", "腹部", "腹膜"], "c": ["憩室炎", "腹腔感染", "腹內膿瘍", "感染"], "a": ["要不要開刀", "定嚴重度", "判時機", "選術式", "找原因", "要不要引流"]},
    // 第 7 輪 c 補「腹內膿瘍」：本頁 desc 寫「壞死感染之 step-up 引流時機」，頁內為
    // 包裹性壞死（WON）的引流適應症——那就是腹內感染性積聚。原本「胰臟的膿瘍」查不到。
    {"k": "panc-path", "name": "急性胰臟炎", "en": "Acute Pancreatitis", "desc": "ERCP 適應症與膽囊切除時機、依 Revised Atlanta 嚴重度處置，及壞死感染之 step-up 引流時機（WSES 2019 · Atlanta 2012）", "kind": "pathway", "href": "pathways/pancreatitis.html", "sec": "abdomen", "secTitle": "腹部急症", "secEn": "Abdominal Emergencies", "grp": "感染", "grpEn": "Infection", "s": ["胰臟", "腹部", "腹膜"], "c": ["胰臟炎", "腹腔感染", "腹內膿瘍", "器官衰竭", "衰竭", "感染"], "a": ["定嚴重度", "要不要開刀", "判時機", "選術式", "找原因", "要不要引流"]},
    ...
    {"k": "trauma-path", "name": "腹部創傷", "en": "Abdominal Trauma", "desc": "依血行動力學反應與 E-FAST 決定是否立即剖腹，可安全影像者依 AAST-OIS 2018 分級給各臟器處置（WSES 2017–2020 · EAST 2010 · WTA 2018–2019）", "kind": "pathway", "href": "pathways/abdominal-trauma.html", "sec": "abdomen", "secTitle": "腹部急症", "secEn": "Abdominal Emergencies", "grp": "出血 / 創傷 / 腹腔高壓", "grpEn": "Hemorrhage · Trauma · Intra-abdominal Hypertension", // 脾臟：AAST-OIS 逐臟器處置含脾修補，E-FAST 左上腹切面就是看脾腎隱窩與脾膈間
"s": ["腹部", "創傷", "肝臟", "胰臟", "腎臟", "脾臟", "胃十二指腸", "大腸", "泌尿系統", "腹膜"], "c": ["腹部創傷", "創傷", "出血"], "a": ["要不要開刀", "定嚴重度", "判時機", "選術式", "找原因", "要不要照CT"]},
    {"k": "iah-path", "name": "腹腔內腔室症候群", "en": "IAH / ACS & Open Abdomen", "desc": "依 IAP 分級與器官功能障礙區分 IAH 與 ACS，腹部打開後以 Björck 分類決定暫時性關腹與確定性關腹策略（WSACS 2013 · Björck 2016 · WSES 2018）", "kind": "pathway", "href": "pathways/iah-acs.html", "sec": "abdomen", "secTitle": "腹部急症", "secEn": "Abdominal Emergencies", "grp": "出血 / 創傷 / 腹腔高壓", "grpEn": "Hemorrhage · Trauma · Intra-abdominal Hypertension", "s": ["腹部", "腹膜"], "c": ["腹腔高壓"], "a": ["定嚴重度", "要不要開刀", "選術式", "判時機", "找原因"]},
    {"k": "emerg-op", "name": "緊急手術分級", "en": "Emergency Surgery Priority Levels", "desc": "依台大醫院緊急手術作業規範查詢急刀級數（第一～五級）與合理等候時間；可用病況或術式關鍵字搜尋，一般外科列於首位，另附排程與滿線徵用原則", "kind": "guide", "href": "tools/emergency-surgery.html", "sec": "abdomen", "secTitle": "腹部急症", "secEn": "Abdominal Emergencies", "grp": "排程 / 分級 / 圍手術期", "grpEn": "Scheduling · Classification · Perioperative", "s": ["手術排程", "病人整體"], "c": ["急刀分級", "手術"], "a": ["判時機", "定嚴重度"]},
        /* ══ s 欄刻意維持窄的兩個詞，不要再擴充 ══════════════════════════════
    ...
    {"k": "classifications", "name": "分類與分級系統", "en": "Grading & Classification Systems", "desc": "腹部急症各疾病的嚴重度分級、解剖分型與影像分期集中於一頁：AAST EGS（16 疾病）、TG18 膽囊炎／膽管炎、ASGE 總膽管結石、Parkland／Nassar、Niemeier、Mirizzi Csendes、WSES CT／Hinchey、Revised Atlanta／DBC／Balthazar CTSI、EHS／Nyhus／Gilbert-Rutkow-Robbins、Forrest；圍手術期之 Clavien-Dindo、ISREC 吻合口漏（併 ISGLS／ISGPS／ECCG 對照）、Clinical Frailty Scale；神經外傷之 Marshall CT 分類與 Rotterdam CT 分數；以及 C. difficile、腸皮／腸道－大氣瘻管、腹腔念珠菌、減重術後急症、乙狀結腸扭轉；循環之 SCAI SHOCK 心因性休克分級（A–E）", "kind": "mega", "href": "tools/classifications.html", "sec": "abdomen", "secTitle": "腹部急症", "secEn": "Abdominal Emergencies", "grp": "排程 / 分級 / 圍手術期", "grpEn": "Scheduling · Classification · Perioperative", "s": ["腹部", "病人整體", "闌尾", "膽道", "胰臟", "胃十二指腸", "小腸", "大腸", "腹壁與疝氣", "腹膜", "腦", "心臟"], "c": ["分類分級", "膽囊炎", "消化道出血", "胰臟炎", "出血", "總膽管結石", "衰弱", "困難梭菌", "闌尾炎", "腹腔感染", "腹內膿瘍", "腹膜炎", "膽管炎", "膽道阻塞", "憩室炎", "消化道穿孔", "消化性潰瘍穿孔", "食道急症", "疝氣", "嵌頓", "腸阻塞", "腸扭轉", "腸缺血", "感染", "皮膚軟組織感染", "侵襲性念珠菌感染", "器官衰竭", "上消化道出血", "術後併發症", "創傷性腦損傷", "蜘蛛膜下腔出血", "心因性休克", "腹腔高壓"], "a": ["定嚴重度", "查分期", "找原因", "查分級系統"]},
    {"k": "periop-anticoag", "name": "圍手術期抗栓藥物管理", "en": "Perioperative Antithrombotic Management", "desc": "依藥物、CrCl 與處置出血風險輸出 DOAC／warfarin 的術前停藥天數、是否橋接、術後重啟時機，附術前用藥日曆；另含抗血小板與支架後手術延遲。刻意並列 CHEST 2022／EHRA 2021／ASRA 第 5 版三套方案而不合併——同一病人三者可差一至兩天，神經軸麻醉與機械瓣橋接的分歧另有標示。另設「急刀／反轉」分頁：以台大急刀五級對應反轉決策與劑量（idarucizumab、4F-PCC、維生素 K），標明 andexanet 已於 2025-12 退出美國市場且 ISTH 列急刀為不應使用", "kind": "guide", "href": "tools/periop-anticoag.html", "sec": "abdomen", "secTitle": "腹部急症", "secEn": "Abdominal Emergencies", "grp": "排程 / 分級 / 圍手術期", "grpEn": "Scheduling · Classification · Perioperative", "s": ["圍手術期", "凝血", "一般藥物"], "c": ["抗栓管理", "出血", "中風風險", "手術"], "a": ["判時機", "查劑量", "查禁忌", "停藥", "逆轉"]},
    {"k": "acls", "name": "ACLS", "en": "Advanced Cardiovascular Life Support", "desc": "依 2025 AHA CPR & ECC 官方 18 張演算法整理：成人之終止復甦、BLS、心跳停止、心搏過速／過緩、電擊整流、復甦後照護、異物哽塞、孕婦停止與 LVAD；另含兒科 PALS 與新生兒復甦。心跳停止、心搏過速與心搏過緩三張做成互動式流程；心電圖判讀圖鑑已獨立為 tools/ekg.html", "kind": "guide", "href": "tools/acls.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "休克與復甦", "grpEn": "Shock & Resuscitation", "s": ["心臟", "意識", "兒科"], "c": ["心跳停止", "心律不整", "意識障礙"], "a": ["查劑量", "判時機", "定嚴重度", "怎麼復甦"]},
    {"k": "sepsis-path", "name": "敗血性休克", "en": "Sepsis & Septic Shock", "desc": "依 SSC 2026（2021 版已被取代）：抗生素時機依「可能／很可能／確定」三級分流（3 小時 vs 1 小時）、感染源控制 6 小時、30 mL/kg 平衡鹽液，到 norepinephrine → vasopressin → epinephrine 的升階；≥65 歲 MAP 目標降為 60–65、升壓劑可先走周邊靜脈", "kind": "pathway", "href": "pathways/sepsis.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "休克與復甦", "grpEn": "Shock & Resuscitation", "s": ["感染與敗血", "休克循環"], "c": ["敗血症", "敗血性休克", "菌血症", "發燒", "感染", "休克"], "a": ["定嚴重度", "查劑量", "判時機", "找原因", "怎麼復甦", "給升壓劑"]},
    {"k": "cs-path", "name": "心因性休克", "en": "Cardiogenic Shock", "desc": "五個分頁。辨識用 SCAI 2022 五級（血壓正常仍可能是休克，C 級以乳酸 ≥2 為界，D 級必須「經過一段時間仍失敗」）與 CPO／PAPi；病因分流逐條引用 2023 ESC ACS——立即冠脈攝影與病灶血管 PCI（I B）、機械併發症手術（I C）、無機械併發症不建議常規 IABP（III B）；支持治療兩段式（起始處方 → 1–2 小時軌跡決定升階），並守住「灌流沒回來之前不利尿、不先給強心劑」；藥物含台大仿單劑量與體重換算、每張藥卡獨立框出禁忌症（nitroglycerin 在休克是仿單禁忌）；證據並列 ECLS-SHOCK 陰性與 DanGer Shock 正面之時間差", "kind": "guide", "href": "pathways/cardiogenic-shock.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "休克與復甦", "grpEn": "Shock & Resuscitation", "s": ["心臟", "休克循環", "升壓與強心藥"], "c": ["心因性休克", "休克"], "a": ["定嚴重度", "查劑量", "判時機", "要不要開刀", "找原因", "給升壓劑"]},
    {"k": "swan", "name": "Swan-Ganz 導管判讀", "en": "Pulmonary Artery Catheter", "desc": "五個分頁。置放波形（RA→RV→PA→楔壓連續示意圖，含右心衰竭時 step-up 消失最易把 RV 誤認為 PA）；數值換算（輸入壓力與 CO 即算出 CI／SVR／PVR／DPG／CPO／PAPi／RA:PAWP／RVSWI／SvO₂ 相關參數並標示異常）；型態判讀互動流程（低血容／左心／右心／填塞／後負荷／分佈性，各附「還要驗證什麼」）＋ Forrester 四象限；異常波形圖示（巨大 v 波、TR 心室化、填塞 y 消失、收縮 vs 限制、whip、阻尼不良、over-wedging）；證據並列四個陰性 RCT 與心因性休克登錄／統合分析的落差（PACCS 仍進行中）", "kind": "guide", "href": "pathways/swan-ganz.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "休克與復甦", "grpEn": "Shock & Resuscitation", "s": ["心臟", "休克循環"], "c": ["血行動力學監測", "休克"], "a": ["定嚴重度", "判時機", "找原因"]},
    {"k": "pe", "name": "肺栓塞", "en": "Acute Pulmonary Embolism", "desc": "依 2019 ESC 之診斷路徑（臨床機率、D-dimer、CTPA）、危險分層（休克、sPESI、右心室功能與心肌指標），到抗凝與再灌流治療與各藥物劑量", "kind": "guide", "href": "tools/pe.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "休克與復甦", "grpEn": "Shock & Resuscitation", "s": ["肺循環"], "c": ["肺栓塞"], "a": ["定嚴重度", "查劑量", "判時機"]},
    {"k": "trauma-resus", "name": "創傷大出血", "en": "Damage Control Resuscitation", "desc": "依 歐洲創傷大出血指引第六版（2023）：TBI 讓每個目標反向——無 TBI 採 permissive hypotension（SBP 80–90、血小板 >50），嚴重 TBI 反而 MAP ≥80、血小板 >100。含 TXA 3 小時門檻（1g/10min＋1g/8h）、FFP:pRBC ≥1:2、fibrinogen ≤1.5 g/L 給 3–4 g、離子鈣與致命三角", "kind": "pathway", "href": "pathways/trauma-resuscitation.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "休克與復甦", "grpEn": "Shock & Resuscitation", "s": ["創傷", "凝血", "休克循環"], "c": ["創傷大出血", "出血", "休克", "創傷"], "a": ["查劑量", "判時機", "定嚴重度", "找原因", "要不要輸血", "怎麼復甦", "怎麼止血"]},
    {"k": "vasoactive", "name": "血管活性藥物對照", "en": "Vasopressors, Inotropes & Inodilators", "desc": "四個分頁。效應對照表把 CO／PAOP／SVR／MAP／HR／CVP／PVR 七個參數 × 十支藥排成一張矩陣，與院外對照表逐格比對、三格不一致處標出理由（vasopressin 的肺阻力、升壓劑一律走中心靜脈、mcg/min 與 mcg/kg/min 在 60 kg 病人差 60 倍）；藥物卡附台大仿單劑量、泡法與即時 mL/hr 換算，並標出台大查無的四支（phenylephrine 針劑、nitroprusside、levosimendan、angiotensin II）；另有依休克型態選藥與試驗證據", "kind": "guide", "href": "tools/vasoactive.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "休克與復甦", "grpEn": "Shock & Resuscitation", "s": ["升壓與強心藥", "休克循環", "心臟", "一般藥物"], "c": ["休克", "敗血性休克", "心因性休克", "心臟衰竭", "血行動力學監測", "劑量換算"], "a": ["查劑量", "給升壓劑", "查禁忌", "怎麼調", "定嚴重度"]},
    {"k": "acs", "name": "急性冠心症", "en": "Acute Coronary Syndrome", "desc": "分流、心電圖判讀、再灌流時機（直接 PCI 與溶栓）、抗栓藥物與依體重換算之劑量；另含支架置放後之 DAPT 時長與緊急 CABG 的處理", "kind": "guide", "href": "tools/acs.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "心臟", "grpEn": "Cardiac", "s": ["冠狀動脈", "心臟"], "c": ["急性冠心症"], "a": ["查劑量", "判時機", "定嚴重度", "選術式"]},
    {"k": "hf", "name": "心臟衰竭", "en": "NTUH Heart Failure Guideline", "desc": "臺大醫院心血管中心第三版（2026/06 修訂）互動版：定義與診斷、HFrEF／HFmrEF／HFpEF 各自的藥物治療、心律處置、急性心衰竭、共病、機械循環支持與周產期心肌病變，末附台大院內流程與文獻", "kind": "guide", "href": "tools/heart-failure.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "心臟", "grpEn": "Cardiac", "s": ["心臟"], "c": ["心臟衰竭", "衰竭"], "a": ["查劑量", "定嚴重度", "給升壓劑"]},
    {"k": "pacemaker", "name": "節律器模式", "en": "Pacemaker Modes", "desc": "六個分頁，含可互動的 NBG 五碼編碼器（選出腔室與反應即翻成白話，並對 AAI 用在房室阻滯、VVI 用在竇性心律這類會出事的組合直接示警）。模式選擇與適應症逐條標 ESC 2021／2018 ACC-AHA-HRS 的 Class；暫時性節律器含經皮、經靜脈與心臟術後心外膜線（感知度數字越小＝越敏感單獨框出）；圍手術期把磁鐵放在節律器上是非同步、放在 ICD 上只停抗頻脈治療的差別放在最前面", "kind": "guide", "href": "tools/pacemaker.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "心臟", "grpEn": "Cardiac", "s": ["心臟", "圍手術期"], "c": ["心搏過緩", "心律不整", "心跳停止"], "a": ["怎麼調", "判時機", "找原因", "怎麼處理", "要不要開刀"]},
    /* 心電圖圖鑑原本是 acls.html 裡的十個分頁，使用者要求抽成獨立頁面並補上
       「非缺血性致命心電圖」與「暈厥八症候群」兩張圖譜提到的型態，故在此新增
       一個標的（acls 的 desc 同步拿掉圖鑑那一段，避免兩處各自宣稱擁有它）。 */
    {"k": "ekg", "name": "心電圖判讀圖鑑", "en": "ECG Pattern Atlas · EKG", "desc": "十一個分頁、七十餘型：竇性、心房、心室、房室阻滯、束支與分支、腔室肥大、節律器、缺血梗塞、全身因素、其他型態，以及猝死型態與暈厥（BE WHAT QT PiE 八症候群，含 ARVC 的 epsilon 波、HOCM 的匕首狀 Q 波、鈉離子通道阻斷的 aVR 終末 R 波、三束支阻滯、短 QT）。每型一張依判讀準則即時合成的示意波形＋判讀準則＋致病原因，另含 QTc 計算器", "kind": "mega", "href": "tools/ekg.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "心臟", "grpEn": "Cardiac", "s": ["心臟", "意識"], "c": ["心律不整", "心跳停止", "心搏過緩", "急性冠心症", "電解質異常", "高血鉀", "低血鉀", "肺栓塞", "意識障礙"], "a": ["找原因", "定嚴重度", "判時機"]},
    {"k": "resp-failure", "name": "呼吸衰竭總論", "en": "Acute Respiratory Failure", "desc": "四型分類 → 病因（心因性肺水腫／COPD 急性惡化／非心因性 AHRF-ARDS／氣喘／幫浦問題／術後／休克）→ 各自的診斷、第一線支持與具體藥物劑量 → 反應評估 → 難治時才進入 ECMO 判定（VV／VA／VAV，含 ELSO 適應症與禁忌）；改善者流程即止，不會走到 ECMO", "kind": "pathway", "href": "pathways/respiratory-failure.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "呼吸衰竭與氣道", "grpEn": "Respiratory Failure & Airway", "s": ["肺與氣道", "呼吸器"], "c": ["呼吸衰竭", "低血氧", "機械通氣", "衰竭", "缺氧"], "a": ["定嚴重度", "查劑量", "判時機", "找原因", "怎麼通氣"]},
    {"k": "ards-path", "name": "急性低血氧與 ARDS", "en": "AHRF & ARDS", "desc": "HFNO → 插管 → 肺保護通氣 → 俯臥 → NMBA → ECMO 的完整升階，含 EOLIA 收案條件；三份現行指引（ESICM 2023／ATS 2024／SSC 2026）在 PEEP、神經肌肉阻斷與類固醇上方向不同，本頁逐條標明出處而不合併", "kind": "pathway", "href": "pathways/ards.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "呼吸衰竭與氣道", "grpEn": "Respiratory Failure & Airway", "s": ["肺與氣道", "呼吸器"], "c": ["ARDS", "低血氧", "呼吸衰竭", "衰竭", "缺氧"], "a": ["定嚴重度", "判時機", "查劑量", "找原因", "要不要插管", "怎麼通氣"]},
    {"k": "lpv", "name": "肺保護通氣", "en": "Lung-Protective Ventilation", "desc": "預測體重與潮氣容積計算、PEEP/FiO₂ 兩張對照表，以及「調不好時怎麼辦」的四路排查——氧合不足、Pplat 過高／驅動壓偏高、呼吸性酸中毒、人機不同步；逐步數字出自 ARDSNet 協定卡（試驗方案），指引條文另行標註", "kind": "pathway", "href": "pathways/lung-protective-ventilation.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "呼吸衰竭與氣道", "grpEn": "Respiratory Failure & Airway", "s": ["呼吸器"], "c": ["機械通氣", "ARDS", "缺氧"], "a": ["查劑量", "定嚴重度", "找原因", "怎麼通氣"]},
    {"k": "rsi", "name": "快速誘導插管", "en": "Rapid Sequence Intubation", "desc": "分「流程、藥物、困難氣道、特殊情境、併發症、證據」六段：誘導與肌肉鬆弛藥物依體重換算劑量，每張藥卡之禁忌症獨立框出；困難氣道與插管後低血壓、去飽和之處置一併列出", "kind": "guide", "href": "tools/rsi.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "呼吸衰竭與氣道", "grpEn": "Respiratory Failure & Airway", "s": ["氣道", "鎮靜止痛"], "c": ["插管"], "a": ["查劑量", "判時機", "要不要插管"]},
    {"k": "aki-path", "name": "急性腎損傷", "en": "AKI & RRT Timing", "desc": "先問緊急適應症、再問是否已到「不宜再等」的界線，最後才是模式與抗凝處方。五個隨機試驗顯示提早啟動不改善死亡率（STARRT-AKI 加速組 90 天仍依賴透析者反而較多），但 AKIKI-2 顯示超過寡尿 72 小時或 BUN 112 mg/dL 之後再拖有害", "kind": "pathway", "href": "pathways/aki-crrt.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "腎臟", "grpEn": "Kidney", "s": ["腎臟"], "c": ["急性腎損傷", "透析時機", "少尿", "衰竭"], "a": ["判時機", "定嚴重度", "查劑量", "找原因", "要不要洗腎"]},
    {"k": "crrt", "name": "CRRT 連續性腎臟替代療法", "en": "Continuous Renal Replacement Therapy", "desc": "五個分頁，接在「該不該洗」之後講「怎麼開」。模式把 CVVH／CVVHD／CVVHDF／SCUF 的差別收斂成兩個問題（溶質靠什麼過去、液體從哪裡進）；處方分頁內建計算器，輸入體重、血流、透析液與前後稀釋即算出前稀釋校正後的實送劑量與濾過分率，偏離 20-25 mL/kg/h 或 FF 大於 25% 時示警；抗凝並列 KDIGO 2012 與 2026 草案（檸檬酸由 2B 升為 1B），附檸檬酸蓄積的判定；溶液與禁忌用台大實際品項（CVVH A／B 液、Prismasol B0、Regiocit）", "kind": "guide", "href": "pathways/crrt.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "腎臟", "grpEn": "Kidney", "s": ["腎臟", "電解質", "體液與滲透壓"], "c": ["急性腎損傷", "透析時機", "腎功能", "電解質異常", "低血磷"], "a": ["怎麼調", "查劑量", "要不要洗腎", "判時機", "查腎肝調整"]},
    {"k": "ich-path", "name": "腦出血與 SAH", "en": "Spontaneous ICH & Aneurysmal SAH", "desc": "兩個分頁。自發性 ICH 依 AHA/ASA 2022：抗栓逆轉是唯一 Class 1，降到 <130 mmHg 與不需開刀者輸血小板都是 Class 3 有害；cerebellar hemorrhage ≥15 mL 或壓迫 brainstem 須立即清除（Class 1），brainstem hemorrhage 指引無建議。Aneurysmal SAH 依 AHA/ASA 2023：24 小時內處理動脈瘤與 enteral nimodipine（唯一 Class 1／LOE A 藥物）；tranexamic acid、statin、magnesium 皆為 Class 3，血壓刻意沒有數字目標", "kind": "guide", "href": "pathways/ich.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "神經", "grpEn": "Neurology", "s": ["腦", "腦血管"], "c": ["腦出血", "蜘蛛膜下腔出血", "出血", "意識障礙"], "a": ["要不要開刀", "判時機", "查劑量", "定嚴重度", "找原因", "要不要輸血"]},
    {"k": "tbi-path", "name": "創傷性腦損傷", "en": "Traumatic Brain Injury", "desc": "依 Bullock 2006 手術門檻與 BTF 第 4 版／SIBICC 階梯：EDH >30 cm³、SDH 厚度 >10 mm 或 shift >5 mm、contusion >50 cm³、posterior fossa 有 mass effect 逐病灶的開刀數字；ICP >22 才治療、CPP 60–70，decompressive craniectomy 的時機決定成敗（DECRA 早期更差 vs RESCUEicp 晚期換命）；corticosteroid 屬 Level I 禁忌，TXA 只在 mild-to-moderate 有益", "kind": "pathway", "href": "pathways/tbi.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "神經", "grpEn": "Neurology", "s": ["腦", "創傷"], "c": ["創傷性腦損傷", "意識障礙", "創傷"], "a": ["定嚴重度", "要不要開刀", "判時機", "找原因", "降腦壓"]},
    {"k": "stroke", "name": "缺血性中風", "en": "Acute Ischemic Stroke", "desc": "依 2026 AHA/ASA 分流、靜脈溶栓（alteplase／tenecteplase 各有劑量上限）、動脈取栓適應症與時間窗，以及血壓、抗栓與併發症之早期處置", "kind": "guide", "href": "tools/stroke.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "神經", "grpEn": "Neurology", "s": ["腦血管"], "c": ["缺血性中風"], "a": ["判時機", "查劑量", "定嚴重度"]},
    {"k": "seizure-path", "name": "癲癇重積", "en": "Seizures & Status Epilepticus", "desc": "五個分頁。診斷依 NICE NG217 與 AAN／AES 2015（EEG 不可用來排除癲癇、首次發作 2 週內轉診）；分類用 ILAE 2025 新版（取代 2017，四大類 21 種發作型）與 ILAE 2015 重積四軸；重積含輸入體重即時換算一線／二線／麻醉輸注劑量與 cEEG、NCSE、超難治處置；另有藥物表與子癲症、酒精戒斷、心跳停止後（TELSTAR：抑制週期性腦波不改善預後）、腦傷後預防用藥等特殊情境", "kind": "guide", "href": "pathways/seizure.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "神經", "grpEn": "Neurology", "s": ["腦", "意識"], "c": ["癲癇重積", "意識障礙"], "a": ["查劑量", "判時機", "找原因"]},
    {"k": "ali-path", "name": "肢體缺血", "en": "Acute Limb Ischaemia", "desc": "依 ESVS 2020：Rutherford 分級（I/IIa/IIb/III）決定速度——所有可挽救肢體先立即全身 heparin；IIa 影像後考慮導管溶栓、IIb 立即再灌流（手術取栓為主，溶栓太慢）、III 一次性截肢（勉強再灌流有害）。含 6P、Doppler 判準與腔室症候群", "kind": "pathway", "href": "pathways/acute-limb-ischemia.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "血管", "grpEn": "Vascular", "s": ["周邊動脈"], "c": ["肢體缺血"], "a": ["定嚴重度", "要不要開刀", "判時機", "選術式", "找原因"]},
    {"k": "aas-path", "name": "主動脈症候群", "en": "Acute Aortic Syndrome", "desc": "依 2022 ACC/AHA：ADD-RS 勾選計分（0–3）分流影像，anti-impulse 順序不可顛倒——先 IV β 阻斷劑到 HR 60–80，血壓仍高才加血管擴張劑到 SBP <120；type A 外科急症、uncomplicated B 內科、complicated B 用 TEVAR", "kind": "pathway", "href": "pathways/acute-aortic-syndrome.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "血管", "grpEn": "Vascular", "s": ["主動脈"], "c": ["主動脈剝離"], "a": ["要不要開刀", "判時機", "定嚴重度", "選術式", "找原因", "要不要照CT"]},
    {"k": "endo-path", "name": "內分泌危象", "en": "Thyroid Storm & Adrenal Crisis", "desc": "兩者都先治療後確診：甲狀腺風暴以 Burch-Wartofsky 分流並列出治療五面向（碘須在 thionamide 之後給）；腎上腺危機依 SfE 2016——立即 hydrocortisone 100 mg、第一小時 1000 mL 生理食鹽水，含礦皮質素時機與生病日規則", "kind": "pathway", "href": "pathways/adrenal-crisis.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "內分泌代謝", "grpEn": "Endocrine & Metabolic", "s": ["甲狀腺", "腎上腺"], "c": ["甲狀腺風暴", "腎上腺危機"], "a": ["查劑量", "定嚴重度", "判時機", "找原因"]},
    {"k": "lyte-path", "name": "電解質急症", "en": "Hyperkalaemia & Hyponatraemia", "desc": "高鉀依 UKKA 2023 五步驟（鈣鹽是 30 mL 10% 葡萄糖酸鈣不是 10 mL；calcium resonium 已不再常規使用）；低鈉依 SfE 2022（150 mL 3% 間歇推注、明確建議不要用 Adrogué-Madias 公式），並內建矯正速率追蹤——算出本 24 小時窗的上限與剩餘額度。含反彈性高鉀與過度矯正（回降、desmopressin）的處理", "kind": "pathway", "href": "pathways/electrolyte-emergency.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "內分泌代謝", "grpEn": "Endocrine & Metabolic", "s": ["電解質", "腎臟"], "c": ["高血鉀", "低血鈉", "電解質異常"], "a": ["查劑量", "定嚴重度", "判時機", "找原因"]},
    {"k": "lyte-all", "name": "電解質失衡", "en": "Na · K · Cl · Ca · Mg · P", "desc": "六個分頁、十二種失衡，每一種都給分級到鑑別路徑到處置三段。參考區間直接取自台大檢驗醫學部，並把台大單位混用的陷阱框出來（鈣鎂是 mmol/L、磷卻是 mg/dL）。高血鉀逐條標 UKKA 2023 的 GRADE，並誠實指出指引首選的兩種鉀結合劑台大都沒有、台大唯一有的樹脂正是指引說不要常規用的那種；高血鈣依 Endocrine Society 2023（denosumab 條件式優於雙磷酸鹽）。急救演算法不重複，指回致命電解質急症頁", "kind": "guide", "href": "pathways/electrolyte.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "內分泌代謝", "grpEn": "Endocrine & Metabolic", "s": ["電解質", "體液與滲透壓", "腎臟"], "c": ["電解質異常", "高血鉀", "低血鉀", "低血鈉", "高血鈉", "高血鈣", "低血鈣", "低血鎂", "低血磷", "高血磷", "再餵食症候群"], "a": ["找原因", "定嚴重度", "查劑量", "怎麼調", "怎麼處理"]},
    {"k": "nutrition", "name": "輸液營養", "en": "IV Fluids & Nutrition", "desc": "七個分頁。晶體輸液把 N/S、half saline、D5W、Dext-saline、L/R、Ringer's 與 Taita 一到五號放進同一張成分表，Taita 的數字取自食藥署仿單原表，並點出台大同時有兩支電解質不同的乳酸林格；靜脈營養液比較 Bfluid／Clinimix／Oliclinomel／Nutriflex／Smoflipid，用滲透壓 800 mOsm/L 決定周邊或中央；添加劑點名 Lyo-Povigent 含維生素 K1 會影響 warfarin、其 thiamine 不足以預防再餵食；計算器把 propofol 的脂肪一起算進 1.5 g/kg/d 額度，並在 GIR 超過 5 mg/kg/min 時示警；時機分頁依 ESPEN 2023，早期全量 EN 與 PN 都不可用（R8, Grade A），PN 在三到七天內開始", "kind": "guide", "href": "pathways/nutrition.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "內分泌代謝", "grpEn": "Endocrine & Metabolic", "s": ["營養", "體液與滲透壓", "電解質", "一般藥物"], "c": ["輸液選擇", "靜脈營養", "營養不良", "再餵食症候群", "電解質異常", "低血磷", "低血鈉"], "a": ["查劑量", "怎麼調", "查禁忌", "判時機", "怎麼處理"]},
    {"k": "dm-path", "name": "糖尿病用藥", "en": "Type 2 Diabetes Pharmacotherapy", "desc": "九個分頁。選藥做成可複選的共病選單——勾 ASCVD、心衰竭、CKD、MASH 加上 eGFR、UACR、A1C、血鉀，即時算出優先用藥、腎功能門檻與健保是否給付。依 ADA Standards of Care 2026 逐條標建議編號與證據等級，並點出三個常被寫錯的數字：住院非重症血糖目標是 100 到 180 不是 140 到 180、ADA 的住院胰島素起始劑量是 0.3 到 0.6 U/kg/day、over-basalization 的大於 0.5 U/kg 門檻 ADA 已經刪掉。各類藥分頁逐藥列出台大品項、劑量、腎肝調整與副作用；胰島素分頁含台大院內十種胰島素的藥動學、起始與 titration、固定比例複方與校正劑量公式的真實出處；住院分頁含類固醇高血糖與管灌 TPN；手術分頁給逐藥停藥表、胰島素 80% 規則、兩版互相衝突的 VRIII 速率表、SGLT2i 停幾天的五種答案與 GLP-1 麻醉前禁食的四份矛盾文件；健保分頁逐條列出指引與給付的七個明確衝突，含口服藥最多四種那一款已於 114 年 6 月 1 日刪除", "kind": "guide", "href": "pathways/diabetes.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "內分泌代謝", "grpEn": "Endocrine & Metabolic", "s": ["血糖", "一般藥物", "腎臟", "圍手術期"], "c": ["糖尿病", "高血糖", "腎功能", "心臟衰竭", "肝硬化", "衰弱", "藥物禁忌", "交互作用"], "a": ["看治療", "查劑量", "怎麼調", "查腎肝調整", "查禁忌", "判時機", "停藥"]},
    // 慢性 B 型肝炎的抗病毒藥物治療。掛在 c 的「HBV」（其 al 已含「B型肝炎」）與
    // 「抗病毒治療」之下；s 掛「肝臟」與「抗病毒藥」。頁面本身同時處理指引適應症與
    // 健保 10.7.3 的逐條判定，所以 a 同時給「判時機」「看治療」「停藥」。
    {"k": "htn-path", "name": "高血壓用藥", "en": "Hypertension Pharmacotherapy", "desc": "九個分頁。選藥做成可複選的共病選單——填診間與居家血壓、年齡、eGFR、UACR、血鉀，勾冠心病、心衰竭、糖尿病、痛風、攝護腺肥大等共病，即時算出三份指引各自的分級、要不要用藥、目標血壓與首選藥。三份現行指引一律並列不合成：2025 AHA/ACC（診間血壓、PREVENT 風險 7.5%）、2024 ESC（新設 Elevated BP 120 到 139 或 70 到 89、目標是 120 到 129 這個有下界的區間）、2022 台灣 TSOC 與 THS（以居家 722 血壓為準、五大類含乙型阻斷劑都是第一線）。點出六個最常被寫錯的地方：AHA 的小於 130/80 只有高風險族群是 Class 1、非高風險只有 2b；台灣的 130/80 是居家血壓而且低風險族群的起始用藥門檻其實是 140/90；ESC 的 Elevated BP 用「或」而 AHA 用「且」；起始雙藥的門檻三家各不相同；原發性醛固酮症篩檢前不用停降壓藥只要停 MRA；住院病人血壓超過 180/120 但無器官損傷時給 PRN 降壓藥是 Class 3 Harm。各類藥分頁逐藥列出台大品項、劑量、腎肝調整、副作用與監測，並標明台大沒有 hydrochlorothiazide 單方與 chlorthalidone、沒有 hydralazine 針、沒有 methyldopa、沒有 nitroprusside。住院分頁含無症狀住院高血壓、高血壓急症的逐器官目標與台大有的靜脈降壓藥。圍手術期分頁給逐藥停續表。健保分頁指出降壓藥在健保給付規定裡幾乎沒有限制，只有 metoprolol succinate 23.75 mg、eplerenone、amiloride、Entresto 與 captopril 內服液五條", "kind": "guide", "href": "pathways/hypertension.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "內分泌代謝", "grpEn": "Endocrine & Metabolic", "s": ["心臟", "血管", "一般藥物", "腎臟", "圍手術期"], "c": ["高血壓", "主動脈剝離", "心臟衰竭", "腎功能", "糖尿病", "懷孕用藥", "藥物禁忌", "交互作用"], "a": ["看治療", "查劑量", "怎麼調", "查腎肝調整", "查禁忌", "判時機", "找原因", "停藥"]},
    {"k": "hbv-path", "name": "B 型肝炎用藥", "en": "Hepatitis B Antiviral Therapy", "desc": "七個分頁。何時治療做成互動判定——填 HBeAg、ALT、HBV DNA、Fibroscan 或 FIB-4，同時算出指引分期（免疫耐受期／免疫活動期／不活動期／灰色地帶）與健保 10.7.3 條款的逐項符合與否，兩邊刻意分開算，因為指引的 ALT 正常值上限是男 35 女 25、健保用的是檢驗室上限（台大 41），ALT 落在 70 到 81 的男性兩邊結論相反。依 AASLD 與 IDSA 2025 指引：灰色地帶從觀察改成用共同決策考慮治療、免疫耐受期超過 40 歲或已達 F2 就建議治療、不建議停藥直到 HBsAg 消失；免疫活動期與肝硬化的適應症該版沒有重寫，仍回 AASLD 2018 guidance。選藥分頁比較 entecavir、TDF、TAF 三支在腎功能、骨質、懷孕、lamivudine 抗藥、失代償肝硬化與 HIV 共感染下的取捨，並點出台大藥卡寫不需調整劑量但美國仿單在 Child-Pugh B 或 C 不建議用 TAF。停藥分頁列出六項全要符合的停藥條件、停藥後追蹤時程與立刻復治療的門檻，以及停藥兩年 HBsAg 消失只有 10.6% 而 ALT 發作有 26.9%、五年有 42% 要重新治療。免疫抑制分頁是 AGA 2025 的再活化風險分層，並列出健保只給 rituximab、anthracycline 與 prednisolone 20 mg 以上三款預防的四個缺口。健保分頁含 10.7.3 與 10.7.4 全條、懷孕與肝癌與移植的給付條款、開立醫師資格，以及第 4 項那份會讓 Viread 比 Baraclude 難過關的十五個品名清單。頁尾附台大藥卡", "kind": "guide", "href": "pathways/hepatitis-b.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "肝臟", "grpEn": "Hepatology", "s": ["肝臟", "抗病毒藥", "一般藥物"], "c": ["HBV", "抗病毒治療", "肝硬化", "肝纖維化", "肝細胞癌", "免疫低下", "懷孕用藥", "藥物禁忌"], "a": ["判時機", "看治療", "查劑量", "停藥", "查禁忌", "查腎肝調整"]},
    {"k": "dka-path", "name": "高血糖危象", "en": "DKA & HHS", "desc": "依 ADA／EASD 2024 共識（2009 年以來首次更新）：血糖門檻降為 ≥200、酮體改用定量 β-羥丁酸、陰離子間隙不再是第一線判準；含依血鉀決定能否開始胰島素、平衡鹽優於生理食鹽水、以及酸中毒停滯時如何分辨高氯性酸中毒", "kind": "pathway", "href": "pathways/dka-hhs.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "內分泌代謝", "grpEn": "Endocrine & Metabolic", "s": ["血糖"], "c": ["DKA", "HHS", "高血糖"], "a": ["查劑量", "定嚴重度", "判時機", "找原因"]},
    {"k": "abg", "name": "動脈血氣分析判讀", "en": "ABG interpretation · Acid–base", "desc": "輸入 pH／PaCO₂／HCO₃⁻ 即判出是哪一型（含急性／慢性呼吸性障礙與混合型），並以 Winter's 等六條代償公式抓出被蓋住的第二個障礙；再由白蛋白校正後的陰離子間隙與 delta gap 自動分流到 GOLDMARK（含滲透壓間隙）、尿液陰離子間隙／RTA 分型或尿液氯", "kind": "tool", "href": "tools/abg.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "一般計算", "grpEn": "General Calculations", "s": ["酸鹼", "肺與氣道"], "c": ["酸鹼失衡", "滲透壓間隙"], "a": ["算分數", "定嚴重度"]},
    {"k": "body-metrics", "name": "體型與劑量體重", "en": "BMI · BSA · IBW · ABW", "desc": "一次算出 BMI（國民健康署體位分類＋WHO 亞洲切點）、BSA（Mosteller 與 Du Bois 並列）、IBW／ABW／LBW，並直接給出 6 mL/kg PBW 的潮氣容積與「實際體重是 IBW 的幾 %、該不該改用 ABW」的判斷", "kind": "tool", "href": "tools/body-metrics.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "一般計算", "grpEn": "General Calculations", "s": ["病人整體", "一般藥物"], "c": ["劑量體重"], "a": ["算分數", "查劑量"]},
    {"k": "dose-conversion", "name": "藥物劑量換算", "en": "Steroid · Opioid · Loop Diuretic", "desc": "三類藥物選「從哪一種換到哪一種」即出等效劑量。類固醇同時顯示礦皮質素活性與作用時間並不等效；鴉片類依 CDC 2022 MME 係數算出每日當量後，把「等效劑量」與「折減 25–50% 後的建議起始劑量」分成兩個數字（methadone／buprenorphine 刻意不提供換入）", "kind": "tool", "href": "tools/dose-conversion.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "一般計算", "grpEn": "General Calculations", "s": ["一般藥物", "鎮靜止痛"], "c": ["劑量換算"], "a": ["查劑量", "算分數"], "kw": "Med conversion"},
    {"k": "corrected-labs", "name": "校正鈉／校正鈣", "en": "Corrected Sodium & Calcium", "desc": "高血糖之校正鈉並列 Katz 1.6 與 Hillier 實測的 2.4（血糖 >400 另有提示）；校正鈣依台大的 mmol/L 報告單位計算並可切換 mg/dL，同時標明危重症與 CRRT 下應直接驗游離鈣的理由", "kind": "tool", "href": "tools/corrected-labs.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "一般計算", "grpEn": "General Calculations", "s": ["電解質"], "c": ["電解質異常", "低血鈉"], "a": ["算分數"]},
    {"k": "osmolality", "name": "血清滲透壓與滲透壓間隙", "en": "Osmolality & Osmolal Gap", "desc": "計算滲透壓、有效滲透壓（tonicity，不含尿素）與滲透壓間隙三者分開呈現；並列兩條常見公式讓你看到間隙隨公式而變，另附由間隙回推毒性酒精濃度。間隙正常不可用來排除毒性酒精中毒（Hoffman 1993 原始結論）", "kind": "tool", "href": "tools/osmolality.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "一般計算", "grpEn": "General Calculations", "s": ["體液與滲透壓", "酸鹼"], "c": ["滲透壓間隙", "低血鈉"], "a": ["算分數"]},
    {"k": "grace", "name": "GRACE", "en": "Global Registry of Acute Coronary Events", "desc": "以年齡、心跳、血壓、肌酸酐、Killip 分級等推估住院與 6 個月死亡風險；> 140 為高風險，NSTE-ACS 建議 24 小時內冠狀動脈攝影", "kind": "tool", "href": "tools/grace.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "急性冠心症", "grpEn": "Acute Coronary Syndrome", "s": ["冠狀動脈", "心臟"], "c": ["急性冠心症"], "a": ["算分數", "定嚴重度", "判時機"]},
    {"k": "wells-pe", "name": "Wells Score (PE)", "en": "Clinical Probability of PE", "desc": "七項準則推估肺栓塞臨床機率，同時顯示三分法與兩分法；決定該驗 D-dimer 還是直接做 CTPA", "kind": "tool", "href": "tools/wells-pe.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "肺栓塞", "grpEn": "Pulmonary Embolism", "s": ["肺循環"], "c": ["肺栓塞"], "a": ["算分數", "定嚴重度"]},
    {"k": "geneva", "name": "Revised Geneva", "en": "Revised & Simplified Geneva Score", "desc": "完整版與簡化版並列計算的肺栓塞臨床機率；全為客觀項目，不含「PE 是否為最可能診斷」的主觀判斷", "kind": "tool", "href": "tools/geneva.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "肺栓塞", "grpEn": "Pulmonary Embolism", "s": ["肺循環"], "c": ["肺栓塞"], "a": ["算分數", "定嚴重度"]},
    {"k": "perc", "name": "PERC Rule", "en": "PE Rule-out Criteria", "desc": "臨床機率已為低時，八項全陰即可不驗 D-dimer 直接排除 PE（漏診率 < 2%）；全有全無的門檻，任一項陽性即不成立", "kind": "tool", "href": "tools/perc.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "肺栓塞", "grpEn": "Pulmonary Embolism", "s": ["肺循環"], "c": ["肺栓塞"], "a": ["算分數"]},
    {"k": "pesi", "name": "PESI／sPESI", "en": "PE Severity Index", "desc": "確診 PE 後的30 天死亡風險分層：原始 PESI（11 項 → Class I–V）與簡化 sPESI（6 項 → 二分）並列，同一組輸入自動換算；抓出可早期出院／門診治療的低危族群，並對接 2019 ESC 的中危分層", "kind": "tool", "href": "tools/pesi.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "肺栓塞", "grpEn": "Pulmonary Embolism", "s": ["肺循環"], "c": ["肺栓塞"], "a": ["算分數", "定嚴重度"], "kw": "PESI sPESI"},
    {"k": "anticoag-reversal", "name": "抗凝／抗血小板逆轉", "en": "Antithrombotic Reversal", "desc": "依 ACC 2020 出血決策路徑選藥即出方案：VKA 的 4F-PCC 依 INR（25/35/50 U/kg）＋vitamin K、dabigatran 的 idarucizumab 5 g、FXa 抑制劑的 andexanet 高/低劑量（依劑量與最後服藥時間）；含肝素、抗血小板（PATCH）與溶栓相關出血", "kind": "tool", "href": "tools/anticoagulant-reversal.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "創傷 / 出血", "grpEn": "Trauma & Hemostasis", "s": ["凝血", "一般藥物"], "c": ["抗栓管理", "出血", "腦出血", "手術"], "a": ["查劑量", "判時機", "查禁忌", "算分數", "逆轉", "怎麼止血"]},
    {"k": "burns", "name": "燒燙傷補液", "en": "Burn Shock Resuscitation", "desc": "輸入體重與 %TBSA 即算 ABA 2024 起始 2 mL/kg/% 與 Parkland 對照的 24 小時量與前/後段速率（含受傷後已過時間修正）；附 rule of nines、尿量終點與 ABA 轉診條件", "kind": "tool", "href": "tools/burns.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "創傷 / 出血", "grpEn": "Trauma & Hemostasis", "s": ["燒燙傷", "創傷"], "c": ["燒燙傷", "創傷"], "a": ["算分數", "查劑量"]},
    {"k": "cci", "name": "Charlson 共病指數", "en": "Charlson Comorbidity Index (CCI)", "desc": "勾選共病項目計算指數，評估共病負荷與10年預估存活率，常用於研究校正與術前風險溝通。注意：與「綜合併發症指數 CCI」同縮寫但完全不同，後者評的是術後併發症負荷", "kind": "tool", "href": "tools/cci.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "共病評估", "grpEn": "Comorbidity", "s": ["病人整體"], "c": ["共病負荷"], "a": ["算分數", "定嚴重度"]},
    {"k": "nihss", "name": "NIHSS", "en": "NIH Stroke Scale", "desc": "15 個項目、0–42 分，含 UN（截肢／插管）不計入總分的處理。標明語言項目權重 9 分而忽略與視野僅 4 分——右半球與後循環中風分數系統性偏低；治療決策看的是失能性缺損而非分數高低", "kind": "tool", "href": "tools/nihss.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "神經", "grpEn": "Neurology", "s": ["腦血管", "意識"], "c": ["缺血性中風"], "a": ["算分數", "定嚴重度"]},
    {"k": "egfr", "name": "eGFR", "en": "2021 CKD-EPI cr / cr-cys", "desc": "與台大檢驗報告同一條公式（≥18 歲採 2021 CKD-EPI）；填入 cystatin C 即自動改用雙標記式並顯示兩式差距與該懷疑哪個標記受干擾。另附 Cockcroft-Gault 與「未經體表面積校正的 GFR」供藥物劑量調整", "kind": "tool", "href": "tools/egfr.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "腎臟", "grpEn": "Kidney", "s": ["腎臟", "一般藥物"], "c": ["腎功能", "衰竭"], "a": ["算分數", "查腎肝調整", "怎麼調"]},
    {"k": "fena", "name": "FeNa／FeUN", "en": "Fractional Excretion of Na / Urea", "desc": "腎前性與 ATN 之鑑別。刻意並列兩篇結論相反的研究——Carvounis 2002 支持「用利尿劑就改看 FeUN」（89% 的腎前性＋利尿劑者 FeUN ≤35%），Pépin 2007 卻顯示其特異度僅 33%、明言不能替代；另列 FeNa 偽低／偽高的完整清單", "kind": "tool", "href": "tools/fena.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "腎臟", "grpEn": "Kidney", "s": ["腎臟"], "c": ["急性腎損傷", "少尿", "衰竭"], "a": ["算分數"], "kw": "FeNa FeUN"},
    {"k": "water-deficit", "name": "高血鈉自由水缺乏", "en": "Free Water Deficit", "desc": "算出缺水量、Adrogué-Madias 每公升輸液的血鈉變化、本日允許降幅所需的輸液量與速率。並標明證據落差：Chauhan 2019 在重症成人未找到快速矯正造成腦水腫的病例，但兒童仍須嚴格限速；公式不含持續損失，必須量測補回", "kind": "tool", "href": "tools/water-deficit.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "腎臟", "grpEn": "Kidney", "s": ["電解質", "體液與滲透壓"], "c": ["高血鈉", "電解質異常"], "a": ["算分數", "查劑量"]},
    {"k": "thyroid-storm", "name": "Burch-Wartofsky", "en": "BWPS for Thyroid Storm", "desc": "甲狀腺風暴的計分（≥45 高度提示、25–44 即將發生、<25 不太可能）；當代研究中 ≥45 敏感度 99% 但特異度僅 12%——是篩檢工具不是診斷準則。含誘發事件與心房顫動獨立計分的提醒", "kind": "tool", "href": "tools/thyroid-storm.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "重症 / 多器官功能", "grpEn": "Critical Care", "s": ["甲狀腺"], "c": ["甲狀腺風暴"], "a": ["算分數", "定嚴重度"]},
    {"k": "dka-hhs", "name": "DKA／HHS 診斷與嚴重度", "en": "Hyperglycemic Crisis Criteria", "desc": "依 2024 共識報告判定 DKA（D／K／A 三項）與 HHS（四項），自動計算有效與總滲透壓並給出建議照護層級；含血糖正常型 DKA 的辨識與「陰離子間隙不可作為緩解判準」的說明", "kind": "tool", "href": "tools/dka-hhs.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "重症 / 多器官功能", "grpEn": "Critical Care", "s": ["血糖"], "c": ["DKA", "HHS", "高血糖"], "a": ["算分數", "定嚴重度"]},
    {"k": "kdigo-aki", "name": "KDIGO AKI 分期", "en": "KDIGO AKI Staging", "desc": "肌酸酐與尿量各自判期後取較嚴重者；含 48 小時 ≥0.3 mg/dL 的絕對上升判準、開始 RRT 即列第 3 期，以及基準肌酸酐取法造成的誤差說明（KDIGO 2026 改版仍在草案階段，本頁依 2012 版）", "kind": "tool", "href": "tools/kdigo-aki.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "重症 / 多器官功能", "grpEn": "Critical Care", "s": ["腎臟"], "c": ["急性腎損傷", "少尿", "衰竭"], "a": ["算分數", "定嚴重度", "查分期"]},
    {"k": "ards", "name": "ARDS 診斷與分級", "en": "ARDS New Global Definition", "desc": "依 2024 新全球定義判定是否成立 ARDS 與嚴重度：可用 SpO₂/FiO₂ 取代動脈血氣、納入未插管（HFNO ≥30 L/min）與資源受限判準，含氧流速估算 FiO₂ 與海拔校正；並列 Berlin 2012 對照", "kind": "tool", "href": "tools/ards.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "重症 / 多器官功能", "grpEn": "Critical Care", "s": ["肺與氣道", "呼吸器"], "c": ["ARDS", "低血氧", "缺氧"], "a": ["算分數", "定嚴重度", "查分期"]},
    {"k": "rox", "name": "ROX Index", "en": "HFNC Outcome Index", "desc": "(SpO₂/FiO₂) ÷ 呼吸速率，用於及早辨識高流量鼻導管注定失敗的病人；失敗切點隨時點上升（2h <2.85／6h <3.47／12h <3.85），≥4.88 與較低插管風險相關", "kind": "tool", "href": "tools/rox.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "重症 / 多器官功能", "grpEn": "Critical Care", "s": ["肺與氣道", "呼吸器"], "c": ["低血氧", "高流量氧氣", "呼吸衰竭", "衰竭", "缺氧"], "a": ["算分數", "判時機"]},
    {"k": "news2", "name": "NEWS2", "en": "National Early Warning Score 2", "desc": "七項生理參數的病情惡化預警分數；SSC 2026 指名 NEWS／NEWS2／MEWS／SIRS 作為敗血症篩檢工具優於 qSOFA。含 SpO₂ Scale 2（高碳酸血症呼吸衰竭專用）與各分數對應的監測頻率與升階層級", "kind": "tool", "href": "tools/news2.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "重症 / 多器官功能", "grpEn": "Critical Care", "s": ["病人整體", "感染與敗血"], "c": ["病情惡化", "敗血症", "發燒", "呼吸急促", "感染"], "a": ["算分數", "定嚴重度", "判時機"]},
    {"k": "sofa", "name": "SOFA", "en": "Sequential Organ Failure Assessment", "desc": "六大器官系統評分；疑似感染病人SOFA上升≥2分，符合Sepsis-3敗血症定義", "kind": "tool", "href": "tools/sofa.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "重症 / 多器官功能", "grpEn": "Critical Care", "s": ["病人整體", "感染與敗血"], "c": ["器官衰竭", "敗血症", "衰竭", "感染"], "a": ["算分數", "定嚴重度"]},
    {"k": "apache", "name": "APACHE II", "en": "Acute Physiology & Chronic Health Eval.", "desc": "評估ICU入住24小時內疾病嚴重度，分數越高住院死亡風險越高", "kind": "tool", "href": "tools/apache.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "重症 / 多器官功能", "grpEn": "Critical Care", "s": ["病人整體"], "c": ["重症死亡風險", "器官衰竭", "衰竭"], "a": ["算分數", "定嚴重度", "判預後"]},
    {"k": "vasopressor", "name": "Vasopressor Calc", "en": "Vasoactive-Inotropic Score", "desc": "計算多重升壓/強心藥物流速並加總VIS，數值越高代表循環支持需求越大", "kind": "tool", "href": "tools/vasopressor.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "重症 / 多器官功能", "grpEn": "Critical Care", "s": ["升壓與強心藥", "休克循環"], "c": ["休克", "心因性休克"], "a": ["查劑量", "算分數", "給升壓劑"]},
    ...
    {"k": "nela", "name": "NELA PRS", "en": "NELA Parsimonious Risk Score", "desc": "急診剖腹術後 30 天死亡率預測，13 項術前變項。本頁為 2023 年 4 月起的新版 PRS，2018 年舊版已由 NELA 明令停用；含 5%／10% 高風險門檻與未經台灣族群校準之警示", "kind": "tool", "href": "tools/nela.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "一般手術風險", "grpEn": "Surgical Risk", "s": ["病人整體", "圍手術期", "腹部"], "c": ["手術死亡風險", "手術"], "a": ["算分數", "定嚴重度", "判預後"]},
    {"k": "possum", "name": "P-POSSUM", "en": "Portsmouth POSSUM", "desc": "預測手術術後 30 天死亡率，常用於手術品質稽核與族群風險校正", "kind": "tool", "href": "tools/p-possum.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "一般手術風險", "grpEn": "Surgical Risk", "s": ["病人整體", "圍手術期"], "c": ["手術死亡風險", "手術"], "a": ["算分數", "定嚴重度", "判預後"]},
    {"k": "sort", "name": "SORT", "en": "Surgical Outcome Risk Tool", "desc": "以 ASA、緊急度、手術別與嚴重度、癌症、年齡預估 30 天全因死亡率，用於術前風險溝通與稽核校正", "kind": "tool", "href": "tools/sort.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "一般手術風險", "grpEn": "Surgical Risk", "s": ["病人整體", "圍手術期"], "c": ["手術死亡風險", "手術"], "a": ["算分數", "定嚴重度", "判預後"]},
    {"k": "iah", "name": "WSACS IAH", "en": "IAH / ACS Grading", "desc": "輸入 IAP 與 MAP 判定 IAH 分級（Grade I–IV）、是否成立 ACS 與 APP；含 primary／secondary／recurrent 分類對減壓時機的影響、WSACS 完整風險因子清單，以及兒童專屬閾值（兒科小組未採納成人分級，故兒童模式不輸出 Grade）", "kind": "tool", "href": "tools/iah.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "一般手術風險", "grpEn": "Surgical Risk", "s": ["腹部", "腹膜"], "c": ["腹腔高壓"], "a": ["算分數", "定嚴重度", "查分期"]},
    {"k": "nutrition-risk", "name": "營養風險評估", "en": "NRS-2002 · GLIM · Refeeding Risk", "desc": "NRS-2002 篩檢（含最常被刪掉的疾病嚴重度原型描述）、GLIM 診斷與嚴重度分級（內建亞洲 BMI 切點）、再餵食風險。NICE 與 ASPEN 刻意分開計算不合併——兩者對「餵食前要不要先矯正低電解質」是相反的指令。外科依據為 ESPEN 2025 更新版（非 2017／2021），術前靜脈營養療程已改為 10–14 天", "kind": "tool", "href": "tools/nutrition-risk.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "圍手術期 / 併發症", "grpEn": "Perioperative & Complications", "s": ["營養", "圍手術期"], "c": ["營養不良", "再餵食症候群"], "a": ["算分數", "定嚴重度"]},
    {"k": "vte-risk", "name": "VTE 風險評估", "en": "Caprini · Padua · IMPROVE Bleeding", "desc": "外科用 Caprini 2005（AT9 收錄版）決定預防強度、內科用 Padua、以 IMPROVE 評出血風險；含腹腔／骨盆腔癌症手術之延長預防。刻意並列兩套互不相容的 Caprini 分級——同為 3–4 分，AT9 稱「中度約 3%」而 Bahl 稱「高度 0.97%」；另標示 AT9 的 ≥5 分給藥門檻與 Pannucci 統合分析「≥7 分才有顯著效益」之落差", "kind": "tool", "href": "tools/vte-risk.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "圍手術期 / 併發症", "grpEn": "Perioperative & Complications", "s": ["靜脈血栓", "圍手術期", "凝血"], "c": ["VTE 風險", "出血"], "a": ["算分數", "定嚴重度"]},
    {"k": "cha2ds2-vasc", "name": "CHA₂DS₂-VASc", "en": "Stroke Risk in Atrial Fibrillation", "desc": "同時算出 CHA₂DS₂-VASc（滿分 9，含性別）與 ESC 2024 改用的 CHA₂DS₂-VA（滿分 8），並分列 ESC 2024／ACC AHA 2023／APHRS 2021 三套門檻——同一位女病人兩套差一分，且 APHRS（台灣主導）在低分時比歐美更早介入。刻意不印每分年中風率表（兩份現行指引皆已不印，跨世代差距達 60 倍）", "kind": "tool", "href": "tools/cha2ds2-vasc.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "圍手術期 / 併發症", "grpEn": "Perioperative & Complications", "s": ["心房顫動", "凝血"], "c": ["中風風險", "抗栓管理", "手術"], "a": ["算分數", "定嚴重度"]},
    {"k": "has-bled", "name": "HAS-BLED", "en": "Bleeding Risk in Atrial Fibrillation", "desc": "逐項計分並單獨列出可矯正的出血因子與矯正後可降到幾分。標明現行指引立場：ESC 2024 已不再納入任何結構化出血風險分數、不建議僅憑出血因子停用抗凝；≥3 分的意思是「矯正因子＋提早追蹤」，不是停藥。含原文的 SI 單位換算（Cr >200 µmol/L ＝ >2.26 mg/dL）", "kind": "tool", "href": "tools/has-bled.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "圍手術期 / 併發症", "grpEn": "Perioperative & Complications", "s": ["心房顫動", "凝血"], "c": ["出血", "抗栓管理", "手術"], "a": ["算分數", "定嚴重度"]},
    {"k": "cci-clavien", "name": "CCI 綜合併發症指數", "en": "Comprehensive Complication Index", "desc": "依 Clavien-Dindo 分級輸入各級併發症件數，合併為 0–100 連續量尺。彌補「只取最高級」遺失累積負荷的問題。與 Charlson 共病指數同縮寫但完全不同", "kind": "tool", "href": "tools/cci-clavien.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "圍手術期 / 併發症", "grpEn": "Perioperative & Complications", "s": ["圍手術期", "病人整體"], "c": ["術後併發症", "手術"], "a": ["算分數", "定嚴重度"]},
    {"k": "aas", "name": "AAS", "en": "Adult Appendicitis Score", "desc": "以性別年齡調整之成人分數（0–24），AUC 0.882 優於 Alvarado 與 AIR；≥16 高度可能、≥18 原文認為可直接手術", "kind": "tool", "href": "tools/aas.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "闌尾炎", "grpEn": "Appendicitis", "s": ["闌尾"], "c": ["闌尾炎"], "a": ["算分數", "定嚴重度"]},
    {"k": "alvarado", "name": "Alvarado", "en": "Alvarado Score", "desc": "評估急性闌尾炎機率，≥7分建議外科會診，敏感度高但特異度較AIR score低", "kind": "tool", "href": "tools/alvarado.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "闌尾炎", "grpEn": "Appendicitis", "s": ["闌尾"], "c": ["闌尾炎"], "a": ["算分數", "定嚴重度"]},
    {"k": "air", "name": "AIR Score", "en": "Appendicitis Inflammatory Response", "desc": "發炎反應導向之闌尾炎評分，特異度優於Alvarado，9–12分高度懷疑闌尾炎", "kind": "tool", "href": "tools/air.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "闌尾炎", "grpEn": "Appendicitis", "s": ["闌尾"], "c": ["闌尾炎"], "a": ["算分數", "定嚴重度"]},
    {"k": "parc", "name": "pARC", "en": "Pediatric Appendicitis Risk Calculator", "desc": "以連續機率量表評估5–18歲兒童闌尾炎風險，較PAS更能區分高低風險族群", "kind": "tool", "href": "tools/parc.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "闌尾炎", "grpEn": "Appendicitis", "s": ["闌尾", "兒科"], "c": ["闌尾炎", "兒童病人"], "a": ["算分數", "定嚴重度"]},
    ...
    {"k": "pulp", "name": "PULP Score", "en": "Peptic Ulcer Perforation Score", "desc": "預測消化性潰瘍穿孔30天死亡率，表現優於傳統Boey score與ASA分級", "kind": "tool", "href": "tools/pulp.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "消化性潰瘍穿孔", "grpEn": "Peptic Ulcer Perforation", "s": ["胃十二指腸", "腹膜"], "c": ["消化性潰瘍穿孔", "消化道穿孔"], "a": ["算分數", "定嚴重度"]},
    {"k": "candida-score", "name": "Candida Score", "en": "Candida Score & Colonization Index", "desc": "非嗜中性球低下危重病人之侵襲性念珠菌感染風險。經驗證的用途是「排除」而非啟動治療；含 2006 迴歸係數版與 2009 整數版的差異、以及 Pittet 移生指數", "kind": "tool", "href": "tools/candida-score.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "腹膜炎", "grpEn": "Peritonitis", "s": ["感染與敗血", "抗黴菌藥"], "c": ["侵襲性念珠菌感染", "免疫低下", "感染"], "a": ["算分數", "定嚴重度"]},
    {"k": "mpi", "name": "MPI", "en": "Mannheim Peritonitis Index", "desc": "評估腹膜炎嚴重度並預測死亡率，分數越高（0–47分）預後越差", "kind": "tool", "href": "tools/mpi.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "腹膜炎", "grpEn": "Peritonitis", "s": ["腹膜"], "c": ["腹膜炎", "腹腔感染", "感染"], "a": ["算分數", "定嚴重度"]},
    {"k": "wses", "name": "WSES Sepsis Score", "en": "WSES Sepsis Severity Score", "desc": "評估複雜性腹內感染之敗血症嚴重度，用於預測死亡率與器官衰竭風險", "kind": "tool", "href": "tools/wses.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "腹膜炎", "grpEn": "Peritonitis", "s": ["腹膜", "感染與敗血"], "c": ["腹膜炎", "腹腔感染", "敗血症", "感染"], "a": ["算分數", "定嚴重度"]},
    {"k": "gbs", "name": "Glasgow-Blatchford", "en": "Glasgow-Blatchford Score", "desc": "上消化道出血內視鏡前風險分層，預測是否需住院介入或死亡；≤1 分可考慮門診處理，各分數中鑑別力最佳（AUROC 0.86）", "kind": "tool", "href": "tools/gbs.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "消化道出血", "grpEn": "GI Bleeding", "s": ["胃十二指腸"], "c": ["消化道出血", "上消化道出血", "出血"], "a": ["算分數", "定嚴重度"]},
    {"k": "rockall", "name": "Rockall Score", "en": "Rockall Score", "desc": "上消化道出血死亡與再出血風險分層，分內視鏡前（0–7）與完整（0–11）兩段；休克分級由血壓心跳自動判定，避免常見的抄錯", "kind": "tool", "href": "tools/rockall.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "消化道出血", "grpEn": "GI Bleeding", "s": ["胃十二指腸"], "c": ["消化道出血", "上消化道出血", "出血"], "a": ["算分數", "定嚴重度"]},
    {"k": "aims65", "name": "AIMS65", "en": "AIMS65 Score", "desc": "上消化道出血住院死亡率預測（白蛋白、INR、意識、收縮壓、年齡各 1 分）；預測死亡優於 GBS，≥2 分為高風險", "kind": "tool", "href": "tools/aims65.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "消化道出血", "grpEn": "GI Bleeding", "s": ["胃十二指腸"], "c": ["消化道出血", "上消化道出血", "出血"], "a": ["算分數", "定嚴重度"]},
    {"k": "oakland", "name": "Oakland Score", "en": "Oakland Score", "desc": "下消化道出血安全出院評估（0–35 分，越低越安全）；≤8 分約 95% 機率可安全出院，血紅素權重最重", "kind": "tool", "href": "tools/oakland.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "消化道出血", "grpEn": "GI Bleeding", "s": ["大腸"], "c": ["消化道出血", "下消化道出血", "出血"], "a": ["算分數", "定嚴重度"]},
    {"k": "wassmer", "name": "Wassmer Score", "en": "Clinical Severity Score for SBO", "desc": "預測黏連性小腸阻塞是否需手術切除腸段，≥4分列為高風險", "kind": "tool", "href": "tools/wassmer.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "腸阻塞", "grpEn": "Bowel Obstruction", "s": ["小腸"], "c": ["腸阻塞", "腸絞窄", "阻塞"], "a": ["算分數", "要不要開刀"]},
    {"k": "angers", "name": "Angers CT Score", "en": "Angers CT Score", "desc": "依CT影像特徵預測黏連性小腸阻塞保守治療失敗風險，≥5分為高風險", "kind": "tool", "href": "tools/angers.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "腸阻塞", "grpEn": "Bowel Obstruction", "s": ["小腸"], "c": ["腸阻塞", "腸絞窄", "阻塞"], "a": ["算分數", "要不要開刀"]},
    {"k": "millet", "name": "Millet Score", "en": "Combined CT Findings for Strangulation", "desc": "結合3項CT徵象評估小腸阻塞絞窄風險，三項皆無時可高信心排除絞窄", "kind": "tool", "href": "tools/millet.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "腸阻塞", "grpEn": "Bowel Obstruction", "s": ["小腸"], "c": ["腸阻塞", "腸絞窄", "阻塞"], "a": ["算分數", "要不要開刀"]},
    {"k": "radial", "name": "RADIAL Score", "en": "RADIAL Score for AMI Mortality", "desc": "預測急性腸繫膜缺血住院死亡率，分數越高（0–13分）死亡率越高", "kind": "tool", "href": "tools/radial.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "腸繫膜缺血", "grpEn": "Mesenteric Ischemia", // 小腸：AMI 就是小腸缺血——pathways/gi-ischemia.html 標題即「Acute mesenteric
     // ischaemia — 小腸為主」，該流程本身也已掛「小腸」。使用者回報「小腸的缺血」查不到這兩支。
     "s": ["腸繫膜血管", "小腸"], "c": ["腸缺血"], "a": ["算分數", "定嚴重度"]},
    {"k": "amiscore", "name": "AMI Diagnostic Score", "en": "Novel Scoring System for AMI Diagnosis", "desc": "以常規血液檢驗（WBC、RDW、MPV、D-dimer）輔助急診鑑別急性腸繫膜缺血", "kind": "tool", "href": "tools/ami.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "腸繫膜缺血", "grpEn": "Mesenteric Ischemia", // 小腸：AMI 就是小腸缺血——pathways/gi-ischemia.html 標題即「Acute mesenteric
     // ischaemia — 小腸為主」，該流程本身也已掛「小腸」。使用者回報「小腸的缺血」查不到這兩支。
     "s": ["腸繫膜血管", "小腸"], "c": ["腸缺血"], "a": ["算分數", "定嚴重度"]},
    {"k": "fib4", "name": "FIB-4", "en": "Fibrosis-4 Index", "desc": "進行性肝纖維化的非侵入性初篩。並列兩套切點——脂肪肝（MASLD）用 1.30／2.67、原始 HIV/HCV 用 1.45／3.25，依病因自動選讀；≥65 歲自動改用 2.0 低風險切點，<35 歲標示敏感度不足。中間帶必須做彈性造影或 ELF，不可停在這一步", "kind": "tool", "href": "tools/fib4.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "肝臟", "grpEn": "Hepatology", "s": ["肝臟"], "c": ["肝纖維化"], "a": ["算分數", "定嚴重度"]},
    {"k": "acute-liver-failure", "name": "急性肝衰竭", "en": "Acute Liver Failure", "desc": "King's College Criteria 移植判準（acetaminophen 與非 acetaminophen 分軌，自動判陽性/未達）；KCC 陰性不排除移植需求。含 NAC 適應症、肝性腦病與顱內壓管理、病因專屬治療（O'Grady 1989／ACG 2023）", "kind": "tool", "href": "tools/acute-liver-failure.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "肝臟", "grpEn": "Hepatology", "s": ["肝臟"], "c": ["急性肝衰竭", "肝移植排序", "衰竭"], "a": ["定嚴重度", "判時機", "算分數", "判預後"]},
    {"k": "childpugh", "name": "Child-Pugh", "en": "Child-Pugh Score", "desc": "評估肝硬化嚴重度分級A/B/C，C級病人手術風險顯著升高", "kind": "tool", "href": "tools/child-pugh.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "肝臟", "grpEn": "Hepatology", "s": ["肝臟"], "c": ["肝硬化", "衰竭"], "a": ["算分數", "定嚴重度", "查腎肝調整", "怎麼調", "判預後"]},
    {"k": "meld", "name": "MELD 3.0", "en": "Model for End-Stage Liver Disease 3.0", "desc": "計算終末期肝病死亡風險，用於肝移植等候名單優先順序排序", "kind": "tool", "href": "tools/meld.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "肝臟", "grpEn": "Hepatology", "s": ["肝臟"], "c": ["肝硬化", "肝移植排序", "衰竭"], "a": ["算分數", "定嚴重度", "判預後"]},
    {"k": "marshall", "name": "Modified Marshall Score", "en": "Organ Failure in Acute Pancreatitis", "desc": "Revised Atlanta 2012 定義器官衰竭之評分：呼吸（PaO₂/FiO₂）、腎臟（Cr）、心血管（收縮壓）任一項 ≥2 分即為器官衰竭；持續 >48 小時為重度", "kind": "tool", "href": "tools/marshall.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "胰臟炎", "grpEn": "Pancreatitis", "s": ["胰臟"], "c": ["胰臟炎", "器官衰竭", "衰竭"], "a": ["算分數", "定嚴重度"]},
    {"k": "lrinec", "name": "LRINEC", "en": "Laboratory Risk Indicator for Necrotizing Fasciitis", "desc": "以 CRP／WBC／Hb／Na／Cr／Glucose 六項常規檢驗（0–13 分）提高壞死性感染的警覺；敏感度僅 68%，不可用於排除診斷", "kind": "tool", "href": "tools/lrinec.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "壞死性軟組織感染", "grpEn": "Necrotizing Soft Tissue Infection", "s": ["軟組織"], "c": ["壞死性軟組織感染", "皮膚軟組織感染", "感染"], "a": ["算分數", "定嚴重度"]},
    {"k": "fgsi", "name": "FGSI / UFGSI", "en": "Fournier's Gangrene Severity Index · Uludağ", "desc": "Fournier's gangrene 預後分層：九項生理參數加總（FGSI），再加侵犯範圍與年齡（UFGSI）；用於加護病房收治判斷，非手術判準", "kind": "tool", "href": "tools/fgsi.html", "sec": "scores", "secTitle": "計分工具", "secEn": "Scoring Tools", "grp": "壞死性軟組織感染", "grpEn": "Necrotizing Soft Tissue Infection", "s": ["會陰", "軟組織"], "c": ["壞死性軟組織感染", "感染"], "a": ["算分數", "定嚴重度", "要不要轉ICU"]},
    ...
    {"k": "hub-ddi", "name": "交互作用查核", "en": "Drug Interactions", "desc": "把病人的藥一個一個加進來，列出所有兩兩配對的交互作用、機轉與處置建議，重大的排最前面 · DDInter 2.0", "kind": "mega", "href": "tools/ddi.html", "sec": "hubs", "secTitle": "入口", "secEn": "Hubs", "grp": "直接指向頁面的入口", "grpEn": "Direct Hubs", "s": ["一般藥物"], "c": ["交互作用", "藥物禁忌", "處方集"], "a": ["查交互作用", "查禁忌", "怎麼處理"], "kw": "DDI ddi drug-drug interaction drug-drug interactions drug drug interaction drug interaction interactions drug-interaction 交互作用 藥物交互作用 藥品交互作用 藥物相互作用 相互作用 併用 合併用藥 一起吃 一起給 同時使用 撞藥 對撞 會不會撞 撞不撞 可不可以一起吃 能不能併用 多重用藥 polypharmacy DDInter major moderate minor 重大 中度 輕度 機轉 處置 management mechanism CYP CYP450 CYP3A4 CYP2C9 CYP2C19 P-gp P-glycoprotein QT QT延長 血清素症候群 serotonin syndrome 橫紋肌溶解 rhabdomyolysis INR"},
    {"k": "cancer-lung", "name": "肺癌", "en": "Lung Cancer", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=lung", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "其他實體腫瘤", "grpEn": "Other Solid Tumors", "s": ["肺與氣道"], "c": ["肺癌", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-esoph", "name": "食道癌", "en": "Esophageal Cancer", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=esoph", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "消化道癌", "grpEn": "GI Cancers", "s": ["食道"], "c": ["食道癌", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-gastric", "name": "胃癌", "en": "Gastric Cancer", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=gastric", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "消化道癌", "grpEn": "GI Cancers", "s": ["胃十二指腸"], "c": ["胃癌", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-panc", "name": "胰臟癌", "en": "Ductal Adenocarcinoma & IPMN / MCN", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=panc", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "消化道癌", "grpEn": "GI Cancers", "s": ["胰臟"], "c": ["胰臟癌", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-gist", "name": "胃腸道基質瘤", "en": "Gastrointestinal Stromal Tumor", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=gist", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "消化道癌", "grpEn": "GI Cancers", "s": ["胃十二指腸", "小腸", "大腸"], "c": ["胃腸道基質瘤", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-colorectal", "name": "大腸直腸癌", "en": "Colorectal Cancer", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=colorectal", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "消化道癌", "grpEn": "GI Cancers", "s": ["大腸"], "c": ["大腸直腸癌", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-anal", "name": "肛門癌", "en": "Anal Cancer (Squamous)", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=anal", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "消化道癌", "grpEn": "GI Cancers", "s": ["會陰"], "c": ["肛門癌", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-appendix", "name": "闌尾癌", "en": "Appendiceal Cancer", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=appendix", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "消化道癌", "grpEn": "GI Cancers", "s": ["闌尾"], "c": ["闌尾癌", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-hcc", "name": "肝細胞癌", "en": "Hepatocellular Carcinoma", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=hcc", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "消化道癌", "grpEn": "GI Cancers", "s": ["肝臟"], "c": ["肝細胞癌", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-cca", "name": "膽管癌", "en": "Cholangiocarcinoma", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=cca", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "消化道癌", "grpEn": "GI Cancers", "s": ["膽道"], "c": ["膽管癌", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-net", "name": "神經內分泌瘤", "en": "Neuroendocrine Tumor", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=net", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "消化道癌", "grpEn": "GI Cancers", "s": ["胰臟", "小腸", "胃十二指腸"], "c": ["神經內分泌瘤", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-breast", "name": "乳癌", "en": "Breast Cancer", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=breast", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "其他實體腫瘤", "grpEn": "Other Solid Tumors", "s": ["乳房"], "c": ["乳癌", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-thyroid", "name": "甲狀腺癌", "en": "Thyroid Cancer", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=thyroid", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "其他實體腫瘤", "grpEn": "Other Solid Tumors", "s": ["甲狀腺"], "c": ["甲狀腺癌", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    // 第 7 輪 s 補「腹部」：js/sts-pathway.js 內含「原發性腹膜後肉瘤（RPS）之獨立流程」，
    // 腹膜後屬腹部。刻意不標「腹膜」——腹膜後腔與腹膜腔是兩個不同的腔室，標了會誤導。
    {"k": "cancer-sts", "name": "軟組織肉瘤", "en": "Soft Tissue Sarcoma", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=sts", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "其他實體腫瘤", "grpEn": "Other Solid Tumors", "s": ["軟組織", "腹部"], "c": ["軟組織肉瘤", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-aml", "name": "急性骨髓性白血病", "en": "Leukemia (Acute Myeloid Leukemia)", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=aml", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "血液腫瘤", "grpEn": "Hematologic Malignancies", "s": ["血液與骨髓"], "c": ["急性骨髓性白血病", "癌症"], "a": ["查分期", "看治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-lymphoma", "name": "淋巴癌", "en": "Lymphoma (Hodgkin & Non-Hodgkin)", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=lymphoma", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "血液腫瘤", "grpEn": "Hematologic Malignancies", "s": ["血液與骨髓"], "c": ["淋巴癌", "癌症"], "a": ["查分期", "看治療", "查淋巴結"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-all", "name": "急性淋巴性白血病", "en": "Acute Lymphoblastic Leukemia", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=all", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "血液腫瘤", "grpEn": "Hematologic Malignancies", "s": ["血液與骨髓"], "c": ["急性淋巴性白血病", "癌症"], "a": ["查分期", "看治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-cml", "name": "慢性骨髓性白血病", "en": "Chronic Myeloid Leukemia", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=cml", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "血液腫瘤", "grpEn": "Hematologic Malignancies", "s": ["血液與骨髓"], "c": ["慢性骨髓性白血病", "癌症"], "a": ["查分期", "看治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-mds", "name": "骨髓分化不良症候群", "en": "Myelodysplastic Syndromes / Neoplasms", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=mds", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "血液腫瘤", "grpEn": "Hematologic Malignancies", "s": ["血液與骨髓"], "c": ["骨髓分化不良症候群", "癌症"], "a": ["查分期", "看治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-mpn", "name": "骨髓增生性腫瘤", "en": "Myeloproliferative Neoplasms (PV / ET / MF)", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=mpn", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "血液腫瘤", "grpEn": "Hematologic Malignancies", "s": ["血液與骨髓"], "c": ["骨髓增生性腫瘤", "癌症"], "a": ["查分期", "看治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-cervix", "name": "子宮頸癌", "en": "Cervical Cancer", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=cervix", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "婦科腫瘤", "grpEn": "Gynecologic Cancers", "s": ["婦科"], "c": ["子宮頸癌", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-endometrial", "name": "子宮內膜癌", "en": "Endometrial Carcinoma", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=endometrial", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "婦科腫瘤", "grpEn": "Gynecologic Cancers", "s": ["婦科"], "c": ["子宮內膜癌", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-utsarc", "name": "子宮肉瘤", "en": "Uterine Sarcoma", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=utsarc", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "婦科腫瘤", "grpEn": "Gynecologic Cancers", "s": ["婦科"], "c": ["子宮肉瘤", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    ...
    {"k": "cancer-ovarian", "name": "卵巢癌", "en": "Ovarian / Fallopian Tube / Primary Peritoneal Cancer", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=ovarian", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "婦科腫瘤", "grpEn": "Gynecologic Cancers", "s": ["婦科", "腹膜"], "c": ["卵巢癌", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-utuc", "name": "上泌尿道腫瘤", "en": "Upper Tract Urothelial Carcinoma", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=utuc", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "泌尿腫瘤", "grpEn": "Urologic Cancers", "s": ["泌尿系統", "腎臟"], "c": ["上泌尿道腫瘤", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-rcc", "name": "腎細胞癌", "en": "Renal Cell Carcinoma", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=rcc", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "泌尿腫瘤", "grpEn": "Urologic Cancers", "s": ["腎臟", "泌尿系統"], "c": ["腎細胞癌", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-bladder", "name": "膀胱癌", "en": "Urinary Bladder Cancer", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=bladder", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "泌尿腫瘤", "grpEn": "Urologic Cancers", "s": ["泌尿系統"], "c": ["膀胱癌", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-prostate", "name": "攝護腺癌", "en": "Prostate Cancer", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=prostate", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "泌尿腫瘤", "grpEn": "Urologic Cancers", "s": ["泌尿系統"], "c": ["攝護腺癌", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-npc", "name": "鼻咽癌", "en": "Nasopharyngeal Carcinoma", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=npc", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "頭頸腫瘤", "grpEn": "Head & Neck Cancers", "s": ["頭頸"], "c": ["鼻咽癌", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "cancer-hnc", "name": "頭頸癌", "en": "Head & Neck Cancer", "desc": "分期、淋巴結分群與治療決策", "kind": "cancer", "href": "tools/cancer.html#cancer=hnc", "sec": "cancer", "secTitle": "癌症治療", "secEn": "Cancer Treatment", "grp": "頭頸腫瘤", "grpEn": "Head & Neck Cancers", "s": ["頭頸"], "c": ["頭頸癌", "癌症"], "a": ["查分期", "選術式", "看治療", "查淋巴結", "要不要輔助治療"], "kw": "癌症 分期 TNM AJCC FIGO 淋巴結 治療 neoadjuvant adjuvant 化療 標靶 免疫"},
    {"k": "abx-mode-empiric", "name": "依部位", "en": "Empiric by Site", "desc": "抗生素指引、菌譜資料庫、手術預防、創傷用藥、注射轉口服、輸注與藥物相容性", "kind": "mode", "href": "tools/antibiotics.html#mode=empiric", "sec": "hubs", "secTitle": "入口", "secEn": "Hubs", "grp": "抗微生物", "grpEn": "Antimicrobials", "s": ["感染與敗血", "腹膜", "腹部", "膽道", "軟組織", "肺與氣道", "腎臟", "心臟", "腦", "泌尿系統"], "c": ["抗生素選擇", "感染"], "a": ["查覆蓋菌譜", "給抗生素"], "kw": "抗生素 抗微生物 經驗性用藥 菌譜 感受性 腹膜炎 腹膜透析 腹透 peritonitis peritoneal dialysis PD CAPD APD 腹腔內注射 intraperitoneal IP"},
    {"k": "abx-mode-bacteria", "name": "依病原菌", "en": "By Pathogen", "desc": "抗生素指引、菌譜資料庫、手術預防、創傷用藥、注射轉口服、輸注與藥物相容性", "kind": "mode", "href": "tools/antibiotics.html#mode=bacteria", "sec": "hubs", "secTitle": "入口", "secEn": "Hubs", "grp": "抗微生物", "grpEn": "Antimicrobials", "s": ["病原菌"], "c": ["抗生素選擇"], "a": ["查覆蓋菌譜", "找原因", "給抗生素"], "kw": "抗生素 抗微生物 經驗性用藥 菌譜 感受性"},
    {"k": "abx-spectrum-database", "name": "菌譜資料庫", "en": "Spectrum Database", "desc": "β-內醯胺酶分類、抗細菌／抗黴菌感受性菌譜、CR-GNB 新藥抗菌譜，整合台大 2026 上半年在地感受性 %S", "kind": "mega", "href": "tools/spectrum-database.html", "sec": "hubs", "secTitle": "入口", "secEn": "Hubs", "grp": "抗微生物", "grpEn": "Antimicrobials", "s": ["抗生素"], "c": ["抗生素選擇"], "a": ["查覆蓋菌譜", "找原因", "給抗生素"], "kw": "抗生素 抗微生物 菌譜 手術預防 創傷"},
    {"k": "abx-surgical-prophylaxis", "name": "手術預防", "en": "Surgical Prophylaxis", "desc": "依台大醫院《手術預防性抗微生物製劑使用規範》（文件 15650-2-000016，版次 8）表一，並以 ASHP／IDSA／SIS／SHEA 2013 指引補充台大表一未列之術式", "kind": "guide", "href": "tools/surgical-prophylaxis.html", "sec": "hubs", "secTitle": "入口", "secEn": "Hubs", "grp": "抗微生物", "grpEn": "Antimicrobials", "s": ["抗生素"], "c": ["抗生素選擇", "手術預防性抗生素", "手術"], "a": ["查覆蓋菌譜", "給抗生素"], "kw": "抗生素 抗微生物 菌譜 手術預防 創傷"},
    {"k": "abx-trauma-abx", "name": "創傷用藥", "en": "Trauma Antibiotics", "desc": "依損傷部位整理創傷後預防性抗生素的建議、療程與證據強度，並含破傷風預防決策", "kind": "guide", "href": "tools/trauma-abx.html", "sec": "hubs", "secTitle": "入口", "secEn": "Hubs", "grp": "抗微生物", "grpEn": "Antimicrobials", "s": ["抗生素"], "c": ["抗生素選擇", "創傷後抗生素", "創傷"], "a": ["查覆蓋菌譜", "給抗生素"], "kw": "抗生素 抗微生物 菌譜 手術預防 創傷"},
    {"k": "abx-iv-to-po", "name": "注射轉口服", "en": "IV to PO Switch", "desc": "依台大醫院《抗微生物製劑注射轉口服劑型建議》（文件 15660-3-000005，版次 1）表一，含七條轉換條件的床邊檢核，與 34 種口服抗微生物製劑的吸收率、吸收部位、管灌可行性", "kind": "guide", "href": "tools/iv-to-po.html", "sec": "hubs", "secTitle": "入口", "secEn": "Hubs", "grp": "抗微生物", "grpEn": "Antimicrobials", "s": ["抗生素"], "c": ["抗生素選擇"], "a": ["給抗生素", "怎麼調", "查劑量"], "kw": "抗生素 抗微生物 注射轉口服 IV to PO switch 口服吸收率 bioavailability 生體可用率 管灌 鼻胃管 鼻空腸管 NJ 降階 de-escalation 停針"},
    {"k": "abx-y-site", "name": "輸注與藥物相容性", "en": "Infusion & Y-site Compatibility", "desc": "依台大醫院《β-lactam 類抗生素輸注時間建議》（文件 15600-3-000002，版次 3），含延長輸注（4 小時）的原則與 52 種常用注射藥品對 8 種 β-lactam 的 Y-site 相容性", "kind": "guide", "href": "tools/y-site.html", "sec": "hubs", "secTitle": "入口", "secEn": "Hubs", "grp": "抗微生物", "grpEn": "Antimicrobials", "s": ["抗生素"], "c": ["抗生素選擇"], "a": ["給抗生素", "怎麼調", "查劑量"], "kw": "抗生素 抗微生物 延長輸注 extended infusion 持續輸注 Y-site 相容性 配伍 藥物相容性 fT>MIC 重症 ICU β-lactam 安定性 溶劑"},
    ...
    {"k": "diet", "name": "飲食指南", "en": "Therapeutic Diets", "desc": "九個分頁。以台大營養室的飲食醫囑單（收費表 2026-07-20）為骨架，把「這個病人該開哪一種飲食」與各疾病的飲食處方放在同一頁，並逐條標出指引版本與建議強度。點出六個常被寫錯的地方：術後不必從清流一級一級爬、但 POD0 直接普通飲食也沒好處；急性胰臟炎「等 lipase 降才吃」被 ESPEN Grade A 否定；KDOQI 2020 已經沒有「限鉀」的克數；心衰竭指引的限鈉其實沒有給數字；憩室症避堅果種子方向是相反的；腸道營養腹瀉時 ESPEN Grade A 是「應常規使用含纖維配方」。另含 IDDSI 2.2（2026-04）質地分級、高輸出量造口的 St Mark's 配方、治療性生酮四型與絕對禁忌、大腸鏡前低渣（USMSTF 2025 已取代清流）與 GLP-1 圍手術期的風險分層", "kind": "guide", "href": "pathways/diet.html", "sec": "critical", "secTitle": "急重症處置", "secEn": "Emergency & Critical Care", "grp": "內分泌代謝", "grpEn": "Endocrine & Metabolic", "s": ["營養", "消化道", "腎臟", "血糖", "圍手術期", "病人整體"], "c": ["營養不良", "糖尿病", "腎功能", "肝硬化", "胰臟炎", "手術"], "a": ["怎麼調", "判時機", "查禁忌", "怎麼處理"]},
  ],
  ...
  "classif": {
    ...
    /* ── 膽道分頁 ─────────────────────────────────────────────────────── */
    "tg18-gb":          {"s": ["膽道"], "c": ["膽囊炎", "腹腔感染"]},        // TG18 急性膽囊炎診斷準則與嚴重度分級
