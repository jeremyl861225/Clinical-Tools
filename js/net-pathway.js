...
(function (global) {
  ...
  function netPathwayHTML() {
    ...
    h += '<p class="onc-note"><b>神經內分泌瘤（GEP-NET）之治療流程，依原發部位分流。</b>' +
      ...
      '分期見「分期」分頁（依部位選擇）。先選原發部位。<br>' +
      '<b>⚠ 分化差之神經內分泌癌（NEC，小細胞／大細胞型）與混合型（MiNEN）不走本頁任何 NET 流程</b>——' +
      '其流程為 <b>PDNEC-1</b>，於<b>步驟 1 選「胰臟」→ 步驟 1 之分化與分級選「分化差 · NEC／MiNEN」</b>可查得。' +
      '<b>該頁標題為「<u>肺外（Extrapulmonary）</u>分化差之神經內分泌癌」，適用範圍涵蓋所有肺外部位</b>' +
      '（含胃、十二指腸、空腸-迴腸、闌尾、結直腸），<b>不限胰臟</b>；本頁將其置於胰臟分支下，' +
      '是因其出處為台大胰臟神經內分泌腫瘤診療指引。</p>';
