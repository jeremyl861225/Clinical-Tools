...
(function (global) {
  ...
  function geneticBlock() {
    return '<div class="bc-gene-h">要不要驗基因？<span class="bc-gene-n">台大 p4、p5 ＋ 院外實證</span></div>' +
      '<ul class="rec-detail bc-gene-list">' + [

        H('什麼時候要懷疑家族史、轉遺傳諮詢？', '台大 p4'),
        ...
        EV('第 ③、⑥、⑦ 項都把卵巢癌算進來 —— 問家族史時只問乳癌會漏掉一整類帶因家庭。' +
          '第 ⑧ 項的男性乳癌不限年齡，這一項最容易被跳過。'),

        H('要驗哪些基因？', '台大未列，院外實證'),
        '<b>符合上面的轉介條件 → 做多基因套組，不是只驗 BRCA1/2。</b>套組要挑「驗到會改變處置」的，不是越大越好。',
        '<b>會改變處置的基因分成三組</b>：' + SUB([
          '<b>會改變手術與預防性手術討論的</b>：BRCA1、BRCA2、PALB2、TP53、PTEN、CDH1、STK11',
          '<b>只改變影像追蹤、不改變手術的</b>：ATM、CHEK2、BARD1',
          '<b>乳房不動、但要轉婦科的</b>：RAD51C、RAD51D、BRIP1 —— 這三個完全不在 BRCA1/2 的檢測範圍內，' +
          '<b>有卵巢癌家族史卻只驗 BRCA，就是漏在這裡</b>'
        ]),
        EV('套組上常見、但<b>不改變乳癌處置</b>的：CDKN2A（與乳癌無確立關聯）、Lynch 症候群四基因' +
          '（乳癌風險 &lt; 15%）、以及 NCCN 明列證據不足的一組（含 <b>NBN</b>、MRE11、RAD50 等）。' +
          '台灣乳房醫學會 2020 年三陰性乳癌共識所列的 20 個基因清單含 NBN —— 那份清單反映當時的 NCCN 版本，' +
          '現行 NCCN 已把 NBN 歸到證據不足組。'),

        '<b>⚠ 台灣有一個對不起來的缺口：藥給付了，檢測沒給付。</b>' + SUB([
          '健保次世代定序（附表 2.2.1）乳癌那一格<b>只給付三陰性乳癌的 BRCA1/2 檢測</b> —— ' +
          '限血液檢體、每人每癌別終生一次，<b>不得申報多基因套組</b>（套組一律自費）',
          '但輔助 olaparib（9.85.4）<b>也給付荷爾蒙受體陽性、HER2 陰性、淋巴結 ≥ 4 顆</b>者 —— ' +
          '<b>這一群要用藥，BRCA 檢測卻不在給付範圍內，只能自費</b>'
        ]),
        EV('2026-06-25 的健保共擬會議已通過增列「早期荷爾蒙受體陽性、HER2 陰性乳癌的 BRCA1/2 檢測」，' +
          '但截至 2026-08-16 尚未見正式公告生效日期。開單前先確認當期公告。'),

        '<b>乳癌的 PARP 抑制劑只認 germline</b>（9.85.2 轉移、9.85.4 輔助）。' +
        '<b>拿腫瘤組織的 somatic BRCA 報告去申請，條文上不符。</b>',
        EV('這個不對稱最容易搞錯：<b>卵巢癌（9.85.1）與去勢抗性攝護腺癌（9.85.3）才可以用 somatic</b>，乳癌不行。' +
          '同一張醫令單（30301B）的名稱寫的是「BRCA1/2 基因檢測（germline or somatic）」，' +
          '但乳癌那一格被附表限縮成 germline ＋ 限血液檢體。'),
        EV('<b>陰性報告的兩個陷阱</b>：① 健保條文只寫「全外顯子分析，包含單核苷酸變異、插入／缺失<b>等</b>」，' +
          '<b>沒有明列大片段重排</b>；台灣乳房醫學會 2019 年 BRCA 檢測共識則是全體專家同意須包含大片段重排偵測。' +
          '沒做缺失／重複分析的陰性報告<b>不等於排除</b>，發報告前要跟實驗室確認方法。' +
          '② 以前只驗過 BRCA1/2 且陰性、但家族史仍符合轉介條件者，可以再做多基因套組。'),

        H('驗到致病變異之後要加做什麼？', '台大未列，院外實證'),
        '<b>三件事會馬上改變門診動作：</b>' + SUB([
          '<b>乳房影像提前</b> —— TP53 從 20 歲、BRCA1/2 從 25 歲起每年乳房磁振造影；' +
          'PALB2、PTEN、CDH1、STK11 從 30 歲；ATM、CHEK2、BARD1 從 40 歲起乳房攝影',
          '<b>對側乳房要不要一起處理</b> —— 上面第一組那七個基因都要把預防性乳房切除放進討論；' +
          'ATM、CHEK2、BARD1 證據不足，<b>依家族史決定，不因基因結果本身而做</b>',
          '<b>轉婦科談預防性輸卵管卵巢切除</b> —— BRCA1 建議 35–40 歲、BRCA2 建議 40–45 歲、' +
          'PALB2 與 RAD51C／RAD51D／BRIP1 為 45–50 歲考慮。' +
          '<b>PTEN、TP53、STK11、CDH1 的卵巢癌風險並沒有增加，不做</b>'
        ]),
        '<b>⚠ 只有 TP53 會改變「這一次」的手術與放療</b>：已診斷乳癌者<b>乳房全切優於腫瘤切除加放射治療</b>；' +
        '治療性放射治療能免則免，除非局部控制或存活的效益大於續發癌風險。',
        '<b>⚠ 反過來，ATM 不是放射治療的禁忌</b> —— 帶單一個致病變異者<b>不可以因此迴避放射治療</b>。',
        EV('<b>台灣的可近性要先講清楚</b>：國健署公費乳房攝影自 114/1/1 起是 <b>40–74 歲每 2 年一次</b>，' +
          '<b>不因基因狀態調整</b>；帶因者的年度乳房磁振造影、預防性乳房切除與重建、預防性輸卵管卵巢切除、' +
          '以及未罹癌家屬的單點（single-site）檢測，都查不到健保給付條文，實務上是自費。'),
        EV('台大 p9 另有一條相關規定：單側乳癌、對側乳房正常而病人因<b>焦慮</b>要求同時全切者，' +
          '應先切除罹癌側、照會精神科，並建議病人考慮 3 至 6 個月。' +
          '<b>那一條是針對焦慮性要求，不是帶因者的預防性切除條文</b>，但它代表院內對非治療性乳房切除的實際流程。')

      ].map(liOf).join('') + '</ul>' +
      '<div class="bc-gene-more">' + geneDetailTable() + '</div>';
  }

  /* 逐基因的完整建議。放在收合裡：門診上真正會用到的是上面那三件事，
     這張表是「要查某一個基因的細節時」才展開。
     ⚠ 出處與版本：NCCN Genetic/Familial High-Risk Assessment: Breast, Ovarian,
     Pancreatic, and Prostate **v1.2025**（GENE-A、BRCA-A、LIFR-A、COWD-A）。
     現行版為 v3.2026，需登入才拿得到，本頁**未以現行版逐條核對**；NCCN 已載明
     v1.2026 對 BRCA、PALB2、TP53、PTEN、CHEK2 有更新。數字一律視為 v1.2025 值。 */
  function geneDetailTable() {
    return fold('逐基因的終生風險與完整監測建議（<b>NCCN v1.2025；台大指引未列</b>）', tbl([
      ['BRCA1',
        '乳癌終生風險 60–72%，對側 20 年 30–40%；卵巢癌 39–58%。<br>' +
        '<b>乳房</b>：25 歲起理學檢查每 6–12 個月；<b>25–29 歲每年乳房磁振造影</b>' +
        '（此段以磁振造影優先，乳房攝影只在做不了磁振造影時用，理由是輻射的<b>理論性</b>風險）；' +
        '<b>30–75 歲每年乳房攝影加磁振造影</b>。<br>' +
        '<b>預防性乳房切除</b>：要討論。<b>卵巢</b>：建議 <b>35–40 歲</b>做預防性輸卵管卵巢切除。'],
      ['BRCA2',
        '乳癌終生風險 55–69%，對側 20 年 25%；卵巢癌 13–29%；<b>男性乳癌 1.8–7.1%</b>。<br>' +
        '<b>乳房</b>：同 BRCA1。男性帶因者 35 歲起自我檢查與每年理學檢查。<br>' +
        '<b>預防性乳房切除</b>：要討論。<b>卵巢</b>：建議 <b>40–45 歲</b>' +
        '（BRCA2 的卵巢癌平均比 BRCA1 晚 8–10 年發病）。'],
      ['PALB2',
        '乳癌終生風險 32–53%；卵巢癌 3–5%。<br>' +
        '<b>處置層級已經和 BRCA 同級</b>：30 歲起每年乳房攝影加磁振造影（是「做」，不是「考慮」）、' +
        '要討論預防性乳房切除、45–50 歲考慮預防性輸卵管卵巢切除。<br>' +
        '<b>把 PALB2 和 ATM／CHEK2 放同一格是錯的。</b><br>' +
        'PALB2 能不能當 PARP 抑制劑的依據？<b>ASCO–SSO 2024 明示證據不足，無法建議贊成或反對。</b>'],
      ['TP53<br>Li-Fraumeni',
        '乳癌終生風險 &gt; 60%，對側 10 年 18–49%。<br>' +
        '<b>這一個會改變本次手術與放療</b>：已診斷乳癌者<b>乳房全切優於腫瘤切除加放射治療</b>；' +
        '治療性放射治療能免則免；診斷性輻射也要盡量減少。<br>' +
        '<b>乳房</b>：20 歲起理學檢查每 6–12 個月；20–29 歲每年磁振造影；30–75 歲每年磁振造影加乳房攝影。<br>' +
        '<b>卵巢</b>：無關聯，不做。<br>' +
        'Li-Fraumeni 的其他器官監測由遺傳諮詢與腫瘤科統籌，不在本頁展開。'],
      ['PTEN<br>Cowden',
        '乳癌終生風險 40–60%。<br>' +
        '<b>乳房</b>：25 歲起理學檢查每 6–12 個月；30 歲起每年乳房攝影加磁振造影。<b>預防性乳房切除</b>：要討論。<br>' +
        '<b>卵巢：風險沒有增加，指引明文不做卵巢切除。</b><br>' +
        '<b>其他會改變門診動作的</b>：35 歲起大腸鏡每 5 年；每年甲狀腺超音波' +
        '（起始年齡在 NCCN 版本之間不一致，v1.2025 為 7 歲、v1.2026 為 12 歲，請依現行版）；' +
        '子宮內膜癌風險增加，35 歲起衛教異常出血、即刻做內膜切片並轉婦科。'],
      ['CDH1<br>遺傳性瀰漫型胃癌',
        '<b>小葉型</b>乳癌終生風險 37–55%。<br>' +
        '<b>乳房</b>：30 歲起每年乳房攝影，並考慮磁振造影。<b>預防性乳房切除</b>：要討論。' +
        '<b>卵巢</b>：無關聯，不做。<br>' +
        '<b>臨床提示：小葉型乳癌合併瀰漫型胃癌家族史，只驗 BRCA1/2 會漏掉。</b><br>' +
        '要轉介腸胃科或對遺傳性瀰漫型胃癌有經驗的中心，討論預防性全胃切除與內視鏡監測的取捨' +
        '（該決策屬 NCCN 另一份指引，本頁未取得原文，不列具體年齡）。'],
      ['STK11<br>Peutz-Jeghers',
        '乳癌終生風險 32–54%。<br>' +
        '<b>乳房</b>：30 歲起每年乳房攝影加磁振造影。<b>預防性乳房切除</b>：要討論。<br>' +
        '<b>上皮性卵巢癌風險沒有增加，不做預防性輸卵管卵巢切除</b>；非上皮性腫瘤的婦科追蹤由遺傳諮詢統籌。'],
      ['ATM<br>CHEK2<br>BARD1',
        '乳癌終生風險：ATM 21–24%、CHEK2 23–27%、BARD1 17–30%（一般人口 12–13%）。<br>' +
        '<b>乳房</b>：40 歲起每年乳房攝影；磁振造影於 ATM 與 CHEK2 自 30–35 歲起「考慮」、BARD1 自 40 歲起「考慮」。<br>' +
        '<b>預防性乳房切除：證據不足，依家族史決定</b>，不因基因結果本身而做。<b>卵巢</b>：都不做。<br>' +
        '<b>⚠ 不可因為帶有 ATM 單一個致病變異就迴避放射治療。</b><br>' +
        '兩個變異層級的例外：ATM 的 c.7271T&gt;G 是高外顯（80 歲前 60%）；' +
        'CHEK2 的風險數字來自 frameshift 變異，Ile157Thr、Ser428Phe 這類 missense 風險較低，不建議據此加強監測。<br>' +
        'CHEK2 的大腸篩檢<b>現行為一般族群篩檢即可</b>（除非本人或一等親有大腸癌或息肉）。'],
      ['RAD51C<br>RAD51D<br>BRIP1',
        '<b>真正改變的是卵巢，不是乳房。</b><br>' +
        '<b>乳房</b>：RAD51C 與 RAD51D 約 20% —— 40 歲起每年乳房攝影、考慮磁振造影，預防性乳房切除證據不足；' +
        '<b>BRIP1 的乳癌證據不足、不足以定義風險，乳房不因此加做</b>。<br>' +
        '<b>卵巢</b>：RAD51C 10–15%、RAD51D 10–20%、BRIP1 5–15%，' +
        '<b>三者都建議 45–50 歲起做預防性輸卵管卵巢切除 → 轉婦科。</b>'],
      ['NF1',
        '<b>乳房</b>：30 歲起每年乳房攝影；磁振造影於 30–50 歲之間考慮；50 歲以後沒有資料支持風險仍升高。<br>' +
        '<b>乳房內的神經纖維瘤會造成磁振造影偽陽性</b>，判讀時要納入。<br>' +
        '預防性乳房切除證據不足，依家族史。卵巢無關聯，不做。'],
      ['出處與版本',
        'NCCN Genetic/Familial High-Risk Assessment: Breast, Ovarian, Pancreatic, and Prostate ' +
        '<b>v1.2025</b>（GENE-A、BRCA-A、LIFR-A、COWD-A）。<br>' +
        '<b>現行版為 v3.2026，需登入才取得，本頁未以現行版逐條核對</b>；' +
        'NCCN 已載明 v1.2026 對 BRCA、PALB2、TP53、PTEN、CHEK2 有更新，上表數字一律視為 v1.2025 值。<br>' +
        '「第一組／第二組」的分層不是 NCCN 的分類，NCCN 只給絕對風險與處置層級。<br>' +
        '<b>台大乳癌診療指引全文沒有任何基因清單、監測建議、預防性手術或家屬檢測的條文</b>' +
        '（唯一具名的基因是 BRCA1/2），本段全部屬院外實證。']
    ]));
  }
